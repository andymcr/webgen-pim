 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.UnitChildAssociationImpl#getServiceFeature <em>Service Feature</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.UnitChildAssociationImpl#getChildFeature <em>Child Feature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitChildAssociationImpl extends UnitChildFeatureImpl implements UnitChildAssociation {
	...
	protected EClass eStaticClass() {
		return WebsitePackage.Literals.UNIT_CHILD_ASSOCIATION;
	}
		...
		if (serviceFeature != null && serviceFeature.eIsProxy()) {
			...
			if (serviceFeature != oldServiceFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebsitePackage.UNIT_CHILD_ASSOCIATION__SERVICE_FEATURE, oldServiceFeature, serviceFeature));
			}
		}
	...
	public void setServiceFeature(ServiceAssociation newServiceFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.UNIT_CHILD_ASSOCIATION__SERVICE_FEATURE, oldServiceFeature, serviceFeature));
	}
	...
	public NotificationChain basicSetChildFeature(UnitChildFeature newChildFeature, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebsitePackage.UNIT_CHILD_ASSOCIATION__CHILD_FEATURE, oldChildFeature, newChildFeature);
	...
	public void setChildFeature(UnitChildFeature newChildFeature) {
		if (newChildFeature != childFeature) {
			...
			if (childFeature != null)
				msgs = ((InternalEObject)childFeature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WebsitePackage.UNIT_CHILD_ASSOCIATION__CHILD_FEATURE, null, msgs);
			if (newChildFeature != null)
				msgs = ((InternalEObject)newChildFeature).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WebsitePackage.UNIT_CHILD_ASSOCIATION__CHILD_FEATURE, null, msgs);
			msgs = basicSetChildFeature(newChildFeature, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.UNIT_CHILD_ASSOCIATION__CHILD_FEATURE, newChildFeature, newChildFeature));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebsitePackage.UNIT_CHILD_ASSOCIATION__SERVICE_FEATURE:
