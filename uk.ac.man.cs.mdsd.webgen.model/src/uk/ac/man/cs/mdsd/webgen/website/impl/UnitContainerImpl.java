...
public abstract class UnitContainerImpl extends EObjectImpl implements UnitContainer {
	...
	protected EClass eStaticClass() {
		return WebsitePackage.Literals.UNIT_CONTAINER;
	}
	...
	public List<ContentUnit> getUnits() {
		if (units == null) {
			units = new EObjectContainmentWithInverseEList<ContentUnit>(ContentUnit.class, this, WebsitePackage.UNIT_CONTAINER__UNITS, WebsitePackage.CONTENT_UNIT__DISPLAYED_ON);
		}
		return units;
	}
