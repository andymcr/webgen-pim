 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.UnitElementImpl#getAttribute <em>Attribute</em>}</li>
...
public class UnitElementImpl extends UnitFeatureImpl implements UnitElement {
		...
		if (attribute != null && attribute.eIsProxy()) {
			...
			if (attribute != oldAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebsitePackage.UNIT_ELEMENT__ATTRIBUTE, oldAttribute, attribute));
			}
		}
		return attribute;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebsitePackage.UNIT_ELEMENT__ATTRIBUTE:
