...
public class FeaturePathAttributeImpl extends FeaturePathImpl implements FeaturePathAttribute {
		...
		if (attribute != null && attribute.eIsProxy()) {
			...
			if (attribute != oldAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebsitePackage.FEATURE_PATH_ATTRIBUTE__ATTRIBUTE, oldAttribute, attribute));
			}
		}
		return attribute;
	}
	...
	public void setAttribute(Attribute newAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.FEATURE_PATH_ATTRIBUTE__ATTRIBUTE, oldAttribute, attribute));
	}
