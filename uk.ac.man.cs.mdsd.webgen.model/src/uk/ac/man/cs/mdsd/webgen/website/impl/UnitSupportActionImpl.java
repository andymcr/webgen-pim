...
public class UnitSupportActionImpl extends NamedDisplayElementImpl implements UnitSupportAction {
	...
	protected EClass eStaticClass() {
		return WebsitePackage.Literals.UNIT_SUPPORT_ACTION;
	}
	...
	public void setConfirmMessage(String newConfirmMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.UNIT_SUPPORT_ACTION__CONFIRM_MESSAGE, oldConfirmMessage, confirmMessage));
	}
