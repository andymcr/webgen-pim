 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ServiceEntityFeatureImpl#getDisplayLabel <em>Display Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ServiceEntityFeatureImpl#isRequired <em>Required</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ServiceEntityFeatureImpl#getForcedValue <em>Forced Value</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ServiceEntityFeatureImpl#getFooter <em>Footer</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ServiceEntityFeatureImpl#getHeaderClass <em>Header Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ServiceEntityFeatureImpl#getInputClass <em>Input Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ServiceEntityFeatureImpl#getDisplayClass <em>Display Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ServiceEntityFeatureImpl#getFooterClass <em>Footer Class</em>}</li>
...
public abstract class ServiceEntityFeatureImpl extends EObjectImpl implements ServiceEntityFeature {
	...
	protected EClass eStaticClass() {
		return WebsitePackage.Literals.SERVICE_ENTITY_FEATURE;
	}
	...
	public void setDisplayLabel(String newDisplayLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.SERVICE_ENTITY_FEATURE__DISPLAY_LABEL, oldDisplayLabel, displayLabel));
	}
	...
	public void setRequired(boolean newRequired) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.SERVICE_ENTITY_FEATURE__REQUIRED, oldRequired, required));
	}
	...
	public NotificationChain basicSetForcedValue(Expression newForcedValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebsitePackage.SERVICE_ENTITY_FEATURE__FORCED_VALUE, oldForcedValue, newForcedValue);
	...
	public void setForcedValue(Expression newForcedValue) {
		if (newForcedValue != forcedValue) {
			...
			if (forcedValue != null)
				msgs = ((InternalEObject)forcedValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WebsitePackage.SERVICE_ENTITY_FEATURE__FORCED_VALUE, null, msgs);
			if (newForcedValue != null)
				msgs = ((InternalEObject)newForcedValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WebsitePackage.SERVICE_ENTITY_FEATURE__FORCED_VALUE, null, msgs);
			msgs = basicSetForcedValue(newForcedValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.SERVICE_ENTITY_FEATURE__FORCED_VALUE, newForcedValue, newForcedValue));
	}
	...
	public void setFooter(String newFooter) {
		...
		footer = newFooter;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.SERVICE_ENTITY_FEATURE__FOOTER, oldFooter, footer));
	}
	...
	public void setDateFormat(String newDateFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.SERVICE_ENTITY_FEATURE__DATE_FORMAT, oldDateFormat, dateFormat));
	}
	...
	public void setHeaderClass(String newHeaderClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.SERVICE_ENTITY_FEATURE__HEADER_CLASS, oldHeaderClass, headerClass));
	}
	...
	public void setInputClass(String newInputClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.SERVICE_ENTITY_FEATURE__INPUT_CLASS, oldInputClass, inputClass));
	}
	...
	public void setDisplayClass(String newDisplayClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.SERVICE_ENTITY_FEATURE__DISPLAY_CLASS, oldDisplayClass, displayClass));
	}
	...
	public void setFooterClass(String newFooterClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.SERVICE_ENTITY_FEATURE__FOOTER_CLASS, oldFooterClass, footerClass));
	}
	...
	public Service getPartOf() {
		if (eContainerFeatureID() != WebsitePackage.SERVICE_ENTITY_FEATURE__PART_OF) return null;
	...
	public NotificationChain basicSetPartOf(Service newPartOf, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newPartOf, WebsitePackage.SERVICE_ENTITY_FEATURE__PART_OF, msgs);
		return msgs;
	}
	...
	public void setPartOf(Service newPartOf) {
		if (newPartOf != eInternalContainer() || (eContainerFeatureID() != WebsitePackage.SERVICE_ENTITY_FEATURE__PART_OF && newPartOf != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.SERVICE_ENTITY_FEATURE__PART_OF, newPartOf, newPartOf));
	}
	...
	public void setAlias(String newAlias) {
		...
		alias = newAlias;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.SERVICE_ENTITY_FEATURE__ALIAS, oldAlias, alias));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebsitePackage.SERVICE_ENTITY_FEATURE__PART_OF:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ServiceFeature.class) {
			switch (derivedFeatureID) {
				case WebsitePackage.SERVICE_ENTITY_FEATURE__PART_OF: return WebsitePackage.SERVICE_FEATURE__PART_OF;
				case WebsitePackage.SERVICE_ENTITY_FEATURE__DATE_FORMAT: return WebsitePackage.SERVICE_FEATURE__DATE_FORMAT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ServiceFeature.class) {
			switch (baseFeatureID) {
				case WebsitePackage.SERVICE_FEATURE__PART_OF: return WebsitePackage.SERVICE_ENTITY_FEATURE__PART_OF;
				case WebsitePackage.SERVICE_FEATURE__DATE_FORMAT: return WebsitePackage.SERVICE_ENTITY_FEATURE__DATE_FORMAT;
				default: return -1;
			}
		}
