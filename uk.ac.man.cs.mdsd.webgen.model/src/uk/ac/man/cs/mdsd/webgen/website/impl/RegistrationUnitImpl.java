...
public class RegistrationUnitImpl extends EObjectImpl implements RegistrationUnit {
	...
	public UnitSource getSource() {
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebsitePackage.REGISTRATION_UNIT__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(UnitSource newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.REGISTRATION_UNIT__SOURCE, oldSource, source));
	}
