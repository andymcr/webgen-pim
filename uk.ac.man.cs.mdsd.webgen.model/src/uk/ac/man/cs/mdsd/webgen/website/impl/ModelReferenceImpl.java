 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ModelReferenceImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelReferenceImpl extends EObjectImpl implements ModelReference {
	...
	protected EClass eStaticClass() {
		return WebsitePackage.Literals.MODEL_REFERENCE;
	}
		...
		if (unit != null && unit.eIsProxy()) {
			...
			if (unit != oldUnit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebsitePackage.MODEL_REFERENCE__UNIT, oldUnit, unit));
			}
		}
		return unit;
	}
	...
	public void setUnit(DynamicUnit newUnit) {
		...
		unit = newUnit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.MODEL_REFERENCE__UNIT, oldUnit, unit));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebsitePackage.MODEL_REFERENCE__UNIT:
