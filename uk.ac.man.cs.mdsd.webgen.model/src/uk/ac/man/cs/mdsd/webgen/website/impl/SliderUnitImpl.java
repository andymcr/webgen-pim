 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.SliderUnitImpl#getStyleClass <em>Style Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.SliderUnitImpl#getContentClass <em>Content Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SliderUnitImpl extends ImageUnitImpl implements SliderUnit {
	...
	protected EClass eStaticClass() {
		return WebsitePackage.Literals.SLIDER_UNIT;
	}
	...
	public void setStyleClass(String newStyleClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.SLIDER_UNIT__STYLE_CLASS, oldStyleClass, styleClass));
	}
	...
	public void setContentClass(String newContentClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.SLIDER_UNIT__CONTENT_CLASS, oldContentClass, contentClass));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebsitePackage.SLIDER_UNIT__STYLE_CLASS:
				return getStyleClass();
			case WebsitePackage.SLIDER_UNIT__CONTENT_CLASS:
