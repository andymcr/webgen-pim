...
public class LoginUnitImpl extends EObjectImpl implements LoginUnit {
	...
	public void setContentClass(String newContentClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.LOGIN_UNIT__CONTENT_CLASS, oldContentClass, contentClass));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (derivedFeatureID) {
				case WebsitePackage.LOGIN_UNIT__NAME: return BasePackage.NAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
		if (baseClass == NamedDisplayElement.class) {
			switch (derivedFeatureID) {
				case WebsitePackage.LOGIN_UNIT__DISPLAY_LABEL: return BasePackage.NAMED_DISPLAY_ELEMENT__DISPLAY_LABEL;
				default: return -1;
			}
		}
		...
		if (baseClass == ControlUnit.class) {
			switch (derivedFeatureID) {
				...
				case WebsitePackage.LOGIN_UNIT__CONTENT_CLASS: return WebsitePackage.CONTROL_UNIT__CONTENT_CLASS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseFeatureID) {
				case BasePackage.NAMED_ELEMENT__NAME: return WebsitePackage.LOGIN_UNIT__NAME;
				default: return -1;
			}
		}
		if (baseClass == NamedDisplayElement.class) {
			switch (baseFeatureID) {
				case BasePackage.NAMED_DISPLAY_ELEMENT__DISPLAY_LABEL: return WebsitePackage.LOGIN_UNIT__DISPLAY_LABEL;
				default: return -1;
			}
		}
		if (baseClass == ContentUnit.class) {
		...
		if (baseClass == ControlUnit.class) {
			switch (baseFeatureID) {
				...
				case WebsitePackage.CONTROL_UNIT__CONTENT_CLASS: return WebsitePackage.LOGIN_UNIT__CONTENT_CLASS;
				default: return -1;
			}
		}
