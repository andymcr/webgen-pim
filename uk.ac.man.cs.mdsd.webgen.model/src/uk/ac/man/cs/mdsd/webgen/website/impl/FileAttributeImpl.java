 ...
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.FileAttributeImpl#getMaximumUploadSize <em>Maximum Upload Size</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.FileAttributeImpl#getValidUploadMimeTypes <em>Valid Upload Mime Types</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.FileAttributeImpl#getValidUploadExtensions <em>Valid Upload Extensions</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.FileAttributeImpl#isUploadsWithinWebsite <em>Uploads Within Website</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.FileAttributeImpl#getRelativeUploadDirectory <em>Relative Upload Directory</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FileAttributeImpl extends AttributeImpl implements FileAttribute {
	...
	protected EClass eStaticClass() {
		return WebsitePackage.Literals.FILE_ATTRIBUTE;
	}
	...
	public void setMaximumUploadSize(int newMaximumUploadSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.FILE_ATTRIBUTE__MAXIMUM_UPLOAD_SIZE, oldMaximumUploadSize, maximumUploadSize));
	}
	...
	public List<String> getValidUploadMimeTypes() {
		if (validUploadMimeTypes == null) {
			validUploadMimeTypes = new EDataTypeUniqueEList<String>(String.class, this, WebsitePackage.FILE_ATTRIBUTE__VALID_UPLOAD_MIME_TYPES);
		}
	...
	public List<String> getValidUploadExtensions() {
		if (validUploadExtensions == null) {
			validUploadExtensions = new EDataTypeUniqueEList<String>(String.class, this, WebsitePackage.FILE_ATTRIBUTE__VALID_UPLOAD_EXTENSIONS);
		}
	...
	public void setUploadsWithinWebsite(boolean newUploadsWithinWebsite) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.FILE_ATTRIBUTE__UPLOADS_WITHIN_WEBSITE, oldUploadsWithinWebsite, uploadsWithinWebsite));
	}
	...
	public void setRelativeUploadDirectory(String newRelativeUploadDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.FILE_ATTRIBUTE__RELATIVE_UPLOAD_DIRECTORY, oldRelativeUploadDirectory, relativeUploadDirectory));
	}
