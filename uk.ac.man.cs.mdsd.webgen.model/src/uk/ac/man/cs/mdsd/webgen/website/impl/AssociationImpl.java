 ...
 * </copyright>
 *
 * $Id: AssociationImpl.java,v 1.10 2013/04/23 10:31:54 andy Exp $
 */
 ...
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.AssociationImpl#getTargetHeaderClass <em>Target Header Class</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.AssociationImpl#getTargetInputClass <em>Target Input Class</em>}</li>
...
public abstract class AssociationImpl extends FeatureImpl implements Association {
	...
	protected EClass eStaticClass() {
		return WebsitePackage.Literals.ASSOCIATION;
	}
		...
		if (targetEntity != null && targetEntity.eIsProxy()) {
			...
			if (targetEntity != oldTargetEntity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebsitePackage.ASSOCIATION__TARGET_ENTITY, oldTargetEntity, targetEntity));
			}
		}
		return targetEntity;
	}
	...
	public NotificationChain basicSetTargetEntity(Entity newTargetEntity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebsitePackage.ASSOCIATION__TARGET_ENTITY, oldTargetEntity, newTargetEntity);
	...
	public void setTargetEntity(Entity newTargetEntity) {
		if (newTargetEntity != targetEntity) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.ASSOCIATION__TARGET_ENTITY, newTargetEntity, newTargetEntity));
	}
	...
	public void setBidirectional(Boolean newBidirectional) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.ASSOCIATION__BIDIRECTIONAL, oldBidirectional, bidirectional));
	}
	...
	public void setInputClass(String newInputClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.ASSOCIATION__INPUT_CLASS, oldInputClass, inputClass));
	}
	...
	public void setTargetFeatureName(String newTargetFeatureName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.ASSOCIATION__TARGET_FEATURE_NAME, oldTargetFeatureName, targetFeatureName));
	}
	...
	public void setTargetDisplayLabel(String newTargetDisplayLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.ASSOCIATION__TARGET_DISPLAY_LABEL, oldTargetDisplayLabel, targetDisplayLabel));
	}
	...
	public void setTargetHeaderClass(String newTargetHeaderClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.ASSOCIATION__TARGET_HEADER_CLASS, oldTargetHeaderClass, targetHeaderClass));
	}
	...
	public void setTargetInputClass(String newTargetInputClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.ASSOCIATION__TARGET_INPUT_CLASS, oldTargetInputClass, targetInputClass));
	}
	...
	public void setTargetDisplayClass(String newTargetDisplayClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.ASSOCIATION__TARGET_DISPLAY_CLASS, oldTargetDisplayClass, targetDisplayClass));
	}
	...
	public void setTargetFooterClass(String newTargetFooterClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.ASSOCIATION__TARGET_FOOTER_CLASS, oldTargetFooterClass, targetFooterClass));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebsitePackage.ASSOCIATION__TARGET_ENTITY:
				if (targetEntity != null)
					msgs = ((InternalEObject)targetEntity).eInverseRemove(this, WebsitePackage.ENTITY__ASSOCIATION_ENDS, Entity.class, msgs);
