...
public class SelectionParameterImpl extends NamedElementImpl implements SelectionParameter {
	...
	protected EClass eStaticClass() {
		return WebsitePackage.Literals.SELECTION_PARAMETER;
	}
	...
	public void setDefaultValue(String newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.SELECTION_PARAMETER__DEFAULT_VALUE, oldDefaultValue, defaultValue));
	}
