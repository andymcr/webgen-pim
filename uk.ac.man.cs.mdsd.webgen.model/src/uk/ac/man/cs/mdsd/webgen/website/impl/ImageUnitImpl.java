 ...
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ImageUnitImpl#getFilters <em>Filters</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ImageUnitImpl#getEmptyMessage <em>Empty Message</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ImageUnitImpl#getPagination <em>Pagination</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ImageUnitImpl#getDefaultPaginationSize <em>Default Pagination Size</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ImageUnitImpl#getNextNpages <em>Next Npages</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ImageUnitImpl#getPreviousNpages <em>Previous Npages</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ImageUnitImpl#getNextPageLabel <em>Next Page Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ImageUnitImpl#getPreviousPageLabel <em>Previous Page Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ImageUnitImpl#isUseDisabledPageLinks <em>Use Disabled Page Links</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ImageUnitImpl#isUseFirstLastPageLinks <em>Use First Last Page Links</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ImageUnitImpl#getFirstPageLabel <em>First Page Label</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ImageUnitImpl#getLastPageLabel <em>Last Page Label</em>}</li>
...
public abstract class ImageUnitImpl extends DynamicUnitImpl implements ImageUnit {
	...
	public void setEmptyMessage(String newEmptyMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.IMAGE_UNIT__EMPTY_MESSAGE, oldEmptyMessage, emptyMessage));
	}
	...
	public Filter getPagination() {
		if (pagination != null && pagination.eIsProxy()) {
			...
			if (pagination != oldPagination) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebsitePackage.IMAGE_UNIT__PAGINATION, oldPagination, pagination));
			}
		}
		return pagination;
	}
	...
	public void setPagination(Filter newPagination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.IMAGE_UNIT__PAGINATION, oldPagination, pagination));
	}
	...
	public void setDefaultPaginationSize(int newDefaultPaginationSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.IMAGE_UNIT__DEFAULT_PAGINATION_SIZE, oldDefaultPaginationSize, defaultPaginationSize));
	}
	...
	public void setNextNpages(int newNextNpages) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.IMAGE_UNIT__NEXT_NPAGES, oldNextNpages, nextNpages));
	}
	...
	public void setPreviousNpages(int newPreviousNpages) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.IMAGE_UNIT__PREVIOUS_NPAGES, oldPreviousNpages, previousNpages));
	}
	...
	public void setNextPageLabel(String newNextPageLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.IMAGE_UNIT__NEXT_PAGE_LABEL, oldNextPageLabel, nextPageLabel));
	}
	...
	public void setPreviousPageLabel(String newPreviousPageLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.IMAGE_UNIT__PREVIOUS_PAGE_LABEL, oldPreviousPageLabel, previousPageLabel));
	}
	...
	public void setUseDisabledPageLinks(boolean newUseDisabledPageLinks) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.IMAGE_UNIT__USE_DISABLED_PAGE_LINKS, oldUseDisabledPageLinks, useDisabledPageLinks));
	}
	...
	public void setUseFirstLastPageLinks(boolean newUseFirstLastPageLinks) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.IMAGE_UNIT__USE_FIRST_LAST_PAGE_LINKS, oldUseFirstLastPageLinks, useFirstLastPageLinks));
	}
	...
	public void setFirstPageLabel(String newFirstPageLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.IMAGE_UNIT__FIRST_PAGE_LABEL, oldFirstPageLabel, firstPageLabel));
	}
	...
	public void setLastPageLabel(String newLastPageLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.IMAGE_UNIT__LAST_PAGE_LABEL, oldLastPageLabel, lastPageLabel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WebsitePackage.IMAGE_UNIT__PAGINATION:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == CollectionUnit.class) {
			switch (derivedFeatureID) {
				...
				case WebsitePackage.IMAGE_UNIT__FILTERS: return WebsitePackage.COLLECTION_UNIT__FILTERS;
				case WebsitePackage.IMAGE_UNIT__EMPTY_MESSAGE: return WebsitePackage.COLLECTION_UNIT__EMPTY_MESSAGE;
				case WebsitePackage.IMAGE_UNIT__PAGINATION: return WebsitePackage.COLLECTION_UNIT__PAGINATION;
				case WebsitePackage.IMAGE_UNIT__DEFAULT_PAGINATION_SIZE: return WebsitePackage.COLLECTION_UNIT__DEFAULT_PAGINATION_SIZE;
				case WebsitePackage.IMAGE_UNIT__NEXT_NPAGES: return WebsitePackage.COLLECTION_UNIT__NEXT_NPAGES;
				case WebsitePackage.IMAGE_UNIT__PREVIOUS_NPAGES: return WebsitePackage.COLLECTION_UNIT__PREVIOUS_NPAGES;
				case WebsitePackage.IMAGE_UNIT__NEXT_PAGE_LABEL: return WebsitePackage.COLLECTION_UNIT__NEXT_PAGE_LABEL;
				case WebsitePackage.IMAGE_UNIT__PREVIOUS_PAGE_LABEL: return WebsitePackage.COLLECTION_UNIT__PREVIOUS_PAGE_LABEL;
				case WebsitePackage.IMAGE_UNIT__USE_DISABLED_PAGE_LINKS: return WebsitePackage.COLLECTION_UNIT__USE_DISABLED_PAGE_LINKS;
				case WebsitePackage.IMAGE_UNIT__USE_FIRST_LAST_PAGE_LINKS: return WebsitePackage.COLLECTION_UNIT__USE_FIRST_LAST_PAGE_LINKS;
				case WebsitePackage.IMAGE_UNIT__FIRST_PAGE_LABEL: return WebsitePackage.COLLECTION_UNIT__FIRST_PAGE_LABEL;
				case WebsitePackage.IMAGE_UNIT__LAST_PAGE_LABEL: return WebsitePackage.COLLECTION_UNIT__LAST_PAGE_LABEL;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == CollectionUnit.class) {
			switch (baseFeatureID) {
				...
				case WebsitePackage.COLLECTION_UNIT__FILTERS: return WebsitePackage.IMAGE_UNIT__FILTERS;
				case WebsitePackage.COLLECTION_UNIT__EMPTY_MESSAGE: return WebsitePackage.IMAGE_UNIT__EMPTY_MESSAGE;
				case WebsitePackage.COLLECTION_UNIT__PAGINATION: return WebsitePackage.IMAGE_UNIT__PAGINATION;
				case WebsitePackage.COLLECTION_UNIT__DEFAULT_PAGINATION_SIZE: return WebsitePackage.IMAGE_UNIT__DEFAULT_PAGINATION_SIZE;
				case WebsitePackage.COLLECTION_UNIT__NEXT_NPAGES: return WebsitePackage.IMAGE_UNIT__NEXT_NPAGES;
				case WebsitePackage.COLLECTION_UNIT__PREVIOUS_NPAGES: return WebsitePackage.IMAGE_UNIT__PREVIOUS_NPAGES;
				case WebsitePackage.COLLECTION_UNIT__NEXT_PAGE_LABEL: return WebsitePackage.IMAGE_UNIT__NEXT_PAGE_LABEL;
				case WebsitePackage.COLLECTION_UNIT__PREVIOUS_PAGE_LABEL: return WebsitePackage.IMAGE_UNIT__PREVIOUS_PAGE_LABEL;
				case WebsitePackage.COLLECTION_UNIT__USE_DISABLED_PAGE_LINKS: return WebsitePackage.IMAGE_UNIT__USE_DISABLED_PAGE_LINKS;
				case WebsitePackage.COLLECTION_UNIT__USE_FIRST_LAST_PAGE_LINKS: return WebsitePackage.IMAGE_UNIT__USE_FIRST_LAST_PAGE_LINKS;
				case WebsitePackage.COLLECTION_UNIT__FIRST_PAGE_LABEL: return WebsitePackage.IMAGE_UNIT__FIRST_PAGE_LABEL;
				case WebsitePackage.COLLECTION_UNIT__LAST_PAGE_LABEL: return WebsitePackage.IMAGE_UNIT__LAST_PAGE_LABEL;
				default: return -1;
			}
		}
