 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ServiceAttributeReferenceImpl#getName <em>Name</em>}</li>
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.website.impl.ServiceAttributeReferenceImpl#getAttribute <em>Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ServiceAttributeReferenceImpl extends ServiceFeatureReferenceImpl implements ServiceAttributeReference {
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate NAME__ESETTING_DELEGATE = ((EStructuralFeature.Internal)WebsitePackage.Literals.SERVICE_ATTRIBUTE_REFERENCE__NAME).getSettingDelegate();
	/**
	...
	protected EClass eStaticClass() {
		return WebsitePackage.Literals.SERVICE_ATTRIBUTE_REFERENCE;
	}
		...
		if (attribute != null && attribute.eIsProxy()) {
			...
			if (attribute != oldAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebsitePackage.SERVICE_ATTRIBUTE_REFERENCE__ATTRIBUTE, oldAttribute, attribute));
			}
		}
		return attribute;
	}
	...
	public void setAttribute(ServiceAttribute newAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.SERVICE_ATTRIBUTE_REFERENCE__ATTRIBUTE, oldAttribute, attribute));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebsitePackage.SERVICE_ATTRIBUTE_REFERENCE__NAME:
				return getName();
			case WebsitePackage.SERVICE_ATTRIBUTE_REFERENCE__ATTRIBUTE:
