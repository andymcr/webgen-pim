 ...
 * </copyright>
 *
 * $Id: DateAttributeImpl.java,v 1.6 2013/12/17 13:57:28 andy Exp $
 */
...
public class DateAttributeImpl extends EntityAttributeImpl implements DateAttribute {
	...
	protected EClass eStaticClass() {
		return WebsitePackage.Literals.DATE_ATTRIBUTE;
	}
	...
	public void setDetails(DateDetails newDetails) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.DATE_ATTRIBUTE__DETAILS, oldDetails, details));
	}
	...
	public void setFormat(String newFormat) {
		...
		format = newFormat;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.DATE_ATTRIBUTE__FORMAT, oldFormat, format));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebsitePackage.DATE_ATTRIBUTE__DETAILS:
				return getDetails();
			case WebsitePackage.DATE_ATTRIBUTE__FORMAT:
				return getFormat();
		}
