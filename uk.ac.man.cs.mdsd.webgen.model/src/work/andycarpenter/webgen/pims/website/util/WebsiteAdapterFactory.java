/**
 */
package work.andycarpenter.webgen.pims.website.util;
...
import work.andycarpenter.webgen.pims.website.*;
...
public class WebsiteAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link work.andycarpenter.webgen.pims.website.WebGenModel <em>Web Gen Model</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link work.andycarpenter.webgen.pims.website.WebsiteProperties <em>Properties</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
