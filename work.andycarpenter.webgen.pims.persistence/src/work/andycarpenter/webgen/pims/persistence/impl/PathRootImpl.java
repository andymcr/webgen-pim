...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Path Root</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.PathRootImpl#getChildFeature <em>Child Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PathRootImpl extends PathImpl implements PathRoot {
	/**
	...
	protected EClass eStaticClass() {
		return PersistencePackage.Literals.PATH_ROOT;
	}
	...
	public NotificationChain basicSetChildFeature(ChildFeature newChildFeature, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PersistencePackage.PATH_ROOT__CHILD_FEATURE, oldChildFeature, newChildFeature);
	...
	public void setChildFeature(ChildFeature newChildFeature) {
		if (newChildFeature != childFeature) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PersistencePackage.PATH_ROOT__CHILD_FEATURE, newChildFeature, newChildFeature));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PersistencePackage.PATH_ROOT__CHILD_FEATURE:
				if (childFeature != null)
					msgs = ((InternalEObject)childFeature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PersistencePackage.PATH_ROOT__CHILD_FEATURE, null, msgs);
