 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.EncapsulatedAssociationImpl#isPseudo <em>Pseudo</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.EncapsulatedAssociationImpl#getEncapsulatedBy <em>Encapsulated By</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.EncapsulatedAssociationImpl#getInputClass <em>Input Class</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.EncapsulatedAssociationImpl#getSourceEntityX <em>Source Entity X</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.EncapsulatedAssociationImpl#getTargetEntityX <em>Target Entity X</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.EncapsulatedAssociationImpl#getSerializationMaxDepth <em>Serialization Max Depth</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.EncapsulatedAssociationImpl#getName <em>Name</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.EncapsulatedAssociationImpl#getAssociation <em>Association</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.EncapsulatedAssociationImpl#getEncapsulatedTarget <em>Encapsulated Target</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.EncapsulatedAssociationImpl#isIsSourceAssociation <em>Is Source Association</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.EncapsulatedAssociationImpl#getCardinality <em>Cardinality</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.EncapsulatedAssociationImpl#getSourceEntity <em>Source Entity</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.EncapsulatedAssociationImpl#getTargetEntity <em>Target Entity</em>}</li>
 * </ul>
 *
 * @generated
 */
