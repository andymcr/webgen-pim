 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.AttributeVariableImpl#getRootContainer <em>Root Container</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.AttributeVariableImpl#isUseContainerAsContext <em>Use Container As Context</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeVariableImpl extends AttributePathElementImpl implements AttributeVariable {
	/**
	...
	protected EClass eStaticClass() {
		return PersistencePackage.Literals.ATTRIBUTE_VARIABLE;
	}
	...
	public void setUseContainerAsContext(boolean newUseContainerAsContext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PersistencePackage.ATTRIBUTE_VARIABLE__USE_CONTAINER_AS_CONTEXT, oldUseContainerAsContext, useContainerAsContext));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PersistencePackage.ATTRIBUTE_VARIABLE__ROOT_CONTAINER:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Expression.class) {
			switch (derivedFeatureID) {
				case PersistencePackage.ATTRIBUTE_VARIABLE__ROOT_CONTAINER: return ExpressionPackage.EXPRESSION__ROOT_CONTAINER;
				default: return -1;
			}
		}
		...
		if (baseClass == FeatureVariable.class) {
			switch (derivedFeatureID) {
				case PersistencePackage.ATTRIBUTE_VARIABLE__USE_CONTAINER_AS_CONTEXT: return PersistencePackage.FEATURE_VARIABLE__USE_CONTAINER_AS_CONTEXT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Expression.class) {
			switch (baseFeatureID) {
				case ExpressionPackage.EXPRESSION__ROOT_CONTAINER: return PersistencePackage.ATTRIBUTE_VARIABLE__ROOT_CONTAINER;
				default: return -1;
			}
		}
		if (baseClass == Operand.class) {
		...
		if (baseClass == FeatureVariable.class) {
			switch (baseFeatureID) {
				case PersistencePackage.FEATURE_VARIABLE__USE_CONTAINER_AS_CONTEXT: return PersistencePackage.ATTRIBUTE_VARIABLE__USE_CONTAINER_AS_CONTEXT;
				default: return -1;
			}
		}
