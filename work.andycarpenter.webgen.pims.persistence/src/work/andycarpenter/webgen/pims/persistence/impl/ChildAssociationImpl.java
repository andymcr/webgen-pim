 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.ChildAssociationImpl#getParent <em>Parent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChildAssociationImpl extends AssociationPathElementImpl implements ChildAssociation {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return PersistencePackage.Literals.CHILD_ASSOCIATION;
	}
	...
	public AssociationPathElement getParent() {
		if (eContainerFeatureID() != PersistencePackage.CHILD_ASSOCIATION__PARENT) return null;
	...
	public NotificationChain basicSetParent(AssociationPathElement newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, PersistencePackage.CHILD_ASSOCIATION__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(AssociationPathElement newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != PersistencePackage.CHILD_ASSOCIATION__PARENT && newParent != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PersistencePackage.CHILD_ASSOCIATION__PARENT, newParent, newParent));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PersistencePackage.CHILD_ASSOCIATION__PARENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ChildFeature.class) {
			switch (derivedFeatureID) {
				case PersistencePackage.CHILD_ASSOCIATION__PARENT: return PersistencePackage.CHILD_FEATURE__PARENT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ChildFeature.class) {
			switch (baseFeatureID) {
				case PersistencePackage.CHILD_FEATURE__PARENT: return PersistencePackage.CHILD_ASSOCIATION__PARENT;
				default: return -1;
			}
		}
