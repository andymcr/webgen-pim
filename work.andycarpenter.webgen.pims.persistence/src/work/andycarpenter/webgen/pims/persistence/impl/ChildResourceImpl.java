...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Child Resource</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.ChildResourceImpl#getParent <em>Parent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChildResourceImpl extends ResourcePathElementImpl implements ChildResource {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected ChildResourceImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PersistencePackage.Literals.CHILD_RESOURCE;
	}
	...
	public void setParent(PathRoot newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != PersistencePackage.CHILD_RESOURCE__PARENT && newParent != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PersistencePackage.CHILD_RESOURCE__PARENT, newParent, newParent));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ChildFeature.class) {
			switch (derivedFeatureID) {
				case PersistencePackage.CHILD_RESOURCE__PARENT: return PersistencePackage.CHILD_FEATURE__PARENT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ChildFeature.class) {
			switch (baseFeatureID) {
				case PersistencePackage.CHILD_FEATURE__PARENT: return PersistencePackage.CHILD_RESOURCE__PARENT;
				default: return -1;
			}
		}
