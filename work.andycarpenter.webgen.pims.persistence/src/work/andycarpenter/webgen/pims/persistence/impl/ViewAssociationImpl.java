 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.ViewAssociationImpl#getTitle <em>Title</em>}</li>
 ...
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.ViewAssociationImpl#getDisplayClass <em>Display Class</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.ViewAssociationImpl#getFooterClass <em>Footer Class</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.ViewAssociationImpl#getPartOf <em>Part Of</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.ViewAssociationImpl#isPseudo <em>Pseudo</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.ViewAssociationImpl#getEncapsulatedBy <em>Encapsulated By</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.ViewAssociationImpl#getInputClass <em>Input Class</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.ViewAssociationImpl#getSourceEntityX <em>Source Entity X</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.ViewAssociationImpl#getTargetEntityX <em>Target Entity X</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.ViewAssociationImpl#getSerializationMaxDepth <em>Serialization Max Depth</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.ViewAssociationImpl#getOpposite <em>Opposite</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.ViewAssociationImpl#getCardinality <em>Cardinality</em>}</li>
 * </ul>
 *
 * @generated
 */
