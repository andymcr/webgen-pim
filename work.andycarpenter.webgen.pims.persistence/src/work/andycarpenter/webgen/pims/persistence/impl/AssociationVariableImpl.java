...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Association Variable</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.AssociationVariableImpl#getRootContainer <em>Root Container</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.persistence.impl.AssociationVariableImpl#isUseContainerAsContext <em>Use Container As Context</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssociationVariableImpl extends AssociationPathElementImpl implements AssociationVariable {
	/**
	 ...
	 * @generated
	 */
	protected AssociationVariableImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PersistencePackage.Literals.ASSOCIATION_VARIABLE;
	}
	...
	public void setUseContainerAsContext(boolean newUseContainerAsContext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PersistencePackage.ASSOCIATION_VARIABLE__USE_CONTAINER_AS_CONTEXT, oldUseContainerAsContext, useContainerAsContext));
	}
	...
	public boolean isSourceAssociation() {
		if (getAssociation() == null) {
			...
			if (getRootContainer() instanceof FeatureVariableContext) {
				final FeatureVariableContext featureContext = (FeatureVariableContext) getRootContainer();
				return featureContext.referencableEntities().stream()
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PersistencePackage.ASSOCIATION_VARIABLE__ROOT_CONTAINER:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Expression.class) {
			switch (derivedFeatureID) {
				case PersistencePackage.ASSOCIATION_VARIABLE__ROOT_CONTAINER: return ExpressionPackage.EXPRESSION__ROOT_CONTAINER;
				default: return -1;
			}
		}
		...
		if (baseClass == FeatureVariable.class) {
			switch (derivedFeatureID) {
				case PersistencePackage.ASSOCIATION_VARIABLE__USE_CONTAINER_AS_CONTEXT: return PersistencePackage.FEATURE_VARIABLE__USE_CONTAINER_AS_CONTEXT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Expression.class) {
			switch (baseFeatureID) {
				case ExpressionPackage.EXPRESSION__ROOT_CONTAINER: return PersistencePackage.ASSOCIATION_VARIABLE__ROOT_CONTAINER;
				default: return -1;
			}
		}
		if (baseClass == Operand.class) {
		...
		if (baseClass == FeatureVariable.class) {
			switch (baseFeatureID) {
				case PersistencePackage.FEATURE_VARIABLE__USE_CONTAINER_AS_CONTEXT: return PersistencePackage.ASSOCIATION_VARIABLE__USE_CONTAINER_AS_CONTEXT;
				default: return -1;
			}
		}
