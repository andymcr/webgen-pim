 ...
 *   <li>{@link uk.ac.man.cs.mdsd.webgen.webui.impl.FilterParameterImpl#getDataType <em>Data Type</em>}</li>
...
public class FilterParameterImpl extends NamedElementImpl implements FilterParameter {
	...
	protected EClass eStaticClass() {
		return WebuiPackage.Literals.FILTER_PARAMETER;
	}
	...
	public Filter getPartOf() {
		if (eContainerFeatureID() != WebuiPackage.FILTER_PARAMETER__PART_OF) return null;
	...
	public NotificationChain basicSetPartOf(Filter newPartOf, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newPartOf, WebuiPackage.FILTER_PARAMETER__PART_OF, msgs);
		return msgs;
	}
	...
	public void setPartOf(Filter newPartOf) {
		if (newPartOf != eInternalContainer() || (eContainerFeatureID() != WebuiPackage.FILTER_PARAMETER__PART_OF && newPartOf != null)) {
			...
			if (newPartOf != null)
				msgs = ((InternalEObject)newPartOf).eInverseAdd(this, WebuiPackage.FILTER__PARAMETERS, Filter.class, msgs);
			msgs = basicSetPartOf(newPartOf, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebuiPackage.FILTER_PARAMETER__PART_OF, newPartOf, newPartOf));
	}
	...
	public DataType getDataType() {
		if (dataType != null && dataType.eIsProxy()) {
			...
			if (dataType != oldDataType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebuiPackage.FILTER_PARAMETER__DATA_TYPE, oldDataType, dataType));
			}
		}
		return dataType;
	}
	...
	public void setDataType(DataType newDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebuiPackage.FILTER_PARAMETER__DATA_TYPE, oldDataType, dataType));
	}
	...
	public void setDefaultValue(String newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebuiPackage.FILTER_PARAMETER__DEFAULT_VALUE, oldDefaultValue, defaultValue));
	}
	...
	public void setPlaceholder(String newPlaceholder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebuiPackage.FILTER_PARAMETER__PLACEHOLDER, oldPlaceholder, placeholder));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebuiPackage.FILTER_PARAMETER__PART_OF:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case WebuiPackage.FILTER_PARAMETER__PART_OF:
				return eInternalContainer().eInverseRemove(this, WebuiPackage.FILTER__PARAMETERS, Filter.class, msgs);
		}
