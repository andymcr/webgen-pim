...
public interface WebuiPackage extends EPackage {
	...
	/**
	 * Returns the meta object for the reference list '{@link uk.ac.man.cs.mdsd.webgen.webui.DynamicUnit#getServicesUsed <em>Services Used</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Services Used</em>'.
	 * @see uk.ac.man.cs.mdsd.webgen.webui.DynamicUnit#getServicesUsed()
	 * @see #getDynamicUnit()
	 * @generated
	 */
