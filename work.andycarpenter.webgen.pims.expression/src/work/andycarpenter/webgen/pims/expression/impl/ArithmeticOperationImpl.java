 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.expression.impl.ArithmeticOperationImpl#getOperands <em>Operands</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.expression.impl.ArithmeticOperationImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArithmeticOperationImpl extends ExpressionImpl implements ArithmeticOperation {
	/**
	...
	protected EClass eStaticClass() {
		return ExpressionPackage.Literals.ARITHMETIC_OPERATION;
	}
	...
	public EList<Expression> getOperands() {
		if (operands == null) {
			operands = new EObjectContainmentEList<Expression>(Expression.class, this, ExpressionPackage.ARITHMETIC_OPERATION__OPERANDS);
		}
		return operands;
	}
	...
	public void setOperator(ArithmeticOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.ARITHMETIC_OPERATION__OPERATOR, oldOperator, operator));
	}
