 ...
 * @generated
 */
public class WebuiModelingAssistantProvider extends ModelingAssistantProvider {
	...
	*/
	protected EObject selectElement(EObject[] elements) {
		...
		dialog.setMessage(Messages.WebuiModelingAssistantProviderMessage);
		dialog.setTitle(Messages.WebuiModelingAssistantProviderTitle);
