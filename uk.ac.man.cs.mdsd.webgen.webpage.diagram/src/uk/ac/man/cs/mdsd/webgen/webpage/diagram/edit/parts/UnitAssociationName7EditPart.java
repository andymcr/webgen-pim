 ...
 * @generated
 */
public class UnitAssociationName7EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UnitAssociationName7EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WebuiParserProvider.getParser(WebuiElementTypes.UnitAssociation_3024, getParserElement(),
					WebuiVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.webpage.diagram.edit.parts.UnitAssociationName7EditPart.VISUAL_ID));
		}
		return parser;
	}
