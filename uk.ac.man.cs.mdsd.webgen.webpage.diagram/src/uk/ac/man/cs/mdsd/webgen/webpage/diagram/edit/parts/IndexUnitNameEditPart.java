 ...
 * @generated
 */
public class IndexUnitNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IndexUnitNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WebuiParserProvider.getParser(WebuiElementTypes.IndexUnit_3006, getParserElement(),
					WebuiVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.webpage.diagram.edit.parts.IndexUnitNameEditPart.VISUAL_ID));
		}
		return parser;
	}
