 ...
 * @generated
 */
public class WebuiBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	* @generated
	*/
	protected WebuiBaseItemSemanticEditPolicy(IElementType elementType) {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(WebuiVisualIDRegistry.getVisualID((View) view));
	...
	*/
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = WebuiElementTypes.getElementType(getVisualID(request));
