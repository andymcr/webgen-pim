...
public class PageLinkReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return WebuiBaseItemSemanticEditPolicy.getLinkConstraints().canExistPageLink_4001(getLink(), getNewSource(),
				target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return WebuiBaseItemSemanticEditPolicy.getLinkConstraints().canExistPageLink_4001(getLink(), source,
				getNewTarget());
	}
