...
import uk.ac.man.cs.mdsd.webgen.webpage.diagram.edit.policies.IndexUnitItemSemanticEditPolicy;
...
public class IndexUnitEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof IndexUnitNameEditPart) {
			((IndexUnitNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureUnitNameLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebuiVisualIDRegistry.getType(IndexUnitNameEditPart.VISUAL_ID));
	}
