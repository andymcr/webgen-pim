 ...
 * @generated
 */
public class UnitElementNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UnitElementNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WebuiParserProvider.getParser(WebuiElementTypes.UnitElement_3013, getParserElement(),
					WebuiVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.webpage.diagram.edit.parts.UnitElementNameEditPart.VISUAL_ID));
		}
		return parser;
	}
