 ...
 * @generated
 */
public class IndexUnitFieldCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WebuiNodeDescriptor> childDescriptors = WebuiDiagramUpdater
				.getIndexUnitFieldCompartment_7007SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == UnitAssociation6EditPart.VISUAL_ID || visualID == UnitElement6EditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<WebuiNodeDescriptor> childDescriptors = WebuiDiagramUpdater
				.getIndexUnitFieldCompartment_7007SemanticChildren((View) getHost().getModel());
