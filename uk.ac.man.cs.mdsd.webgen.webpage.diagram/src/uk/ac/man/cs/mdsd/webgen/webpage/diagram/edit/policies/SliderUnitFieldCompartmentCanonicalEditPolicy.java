 ...
 * @generated
 */
public class SliderUnitFieldCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WebuiNodeDescriptor> childDescriptors = WebuiDiagramUpdater
				.getSliderUnitFieldCompartment_7010SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == UnitAssociation9EditPart.VISUAL_ID || visualID == UnitElement9EditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<WebuiNodeDescriptor> childDescriptors = WebuiDiagramUpdater
				.getSliderUnitFieldCompartment_7010SemanticChildren((View) getHost().getModel());
