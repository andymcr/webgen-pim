...
import uk.ac.man.cs.mdsd.webgen.webpage.diagram.edit.policies.UpdateUnitItemSemanticEditPolicy;
 ...
 * @generated
 */
public class UpdateUnitEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public UpdateUnitEditPart(View view) {
		super(view);
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UpdateUnitNameEditPart) {
			((UpdateUnitNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureUnitNameLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebuiVisualIDRegistry.getType(UpdateUnitNameEditPart.VISUAL_ID));
	}
