 ...
 * @generated
 */
public class WebuiDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	* @generated
	*/
	public WebuiDomainNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof WebuiDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((WebuiDomainNavigatorItem) parentElement).getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new WebuiDomainNavigatorItem((EObject) objects[i], parentElement,
