 ...
 * @generated
 */
public class PageUnitCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WebuiNodeDescriptor> childDescriptors = WebuiDiagramUpdater
				.getPageUnitCompartment_7001SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<WebuiNodeDescriptor> childDescriptors = WebuiDiagramUpdater
				.getPageUnitCompartment_7001SemanticChildren((View) getHost().getModel());
