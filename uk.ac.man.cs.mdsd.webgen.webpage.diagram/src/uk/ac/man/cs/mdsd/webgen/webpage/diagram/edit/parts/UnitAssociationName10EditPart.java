...
import uk.ac.man.cs.mdsd.webgen.webpage.diagram.edit.policies.WebuiTextSelectionEditPolicy;
 ...
 * @generated
 */
public class UnitAssociationName10EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UnitAssociationName10EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new WebuiTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return WebuiElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WebuiParserProvider.getParser(WebuiElementTypes.UnitAssociation_3030, getParserElement(),
					WebuiVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.webpage.diagram.edit.parts.UnitAssociationName10EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, WebuiEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
