 ...
 * @generated
 */
public class CreateUpdateUnitFieldCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WebuiNodeDescriptor> childDescriptors = WebuiDiagramUpdater
				.getCreateUpdateUnitFieldCompartment_7003SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		int visualID = WebuiVisualIDRegistry.getVisualID(view);
		return visualID == UnitAssociation2EditPart.VISUAL_ID || visualID == UnitElement2EditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<WebuiNodeDescriptor> childDescriptors = WebuiDiagramUpdater
				.getCreateUpdateUnitFieldCompartment_7003SemanticChildren((View) getHost().getModel());
