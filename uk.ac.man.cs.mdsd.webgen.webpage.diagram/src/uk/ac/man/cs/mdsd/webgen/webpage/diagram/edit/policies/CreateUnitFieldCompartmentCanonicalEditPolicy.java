 ...
 * @generated
 */
public class CreateUnitFieldCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WebuiNodeDescriptor> childDescriptors = WebuiDiagramUpdater
				.getCreateUnitFieldCompartment_7002SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == UnitAssociationEditPart.VISUAL_ID || visualID == UnitElementEditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<WebuiNodeDescriptor> childDescriptors = WebuiDiagramUpdater
				.getCreateUnitFieldCompartment_7002SemanticChildren((View) getHost().getModel());
