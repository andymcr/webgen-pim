 ...
 * @generated
 */
public class UnitElementName4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UnitElementName4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WebuiParserProvider.getParser(WebuiElementTypes.UnitElement_3019, getParserElement(),
					WebuiVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.webpage.diagram.edit.parts.UnitElementName4EditPart.VISUAL_ID));
		}
		return parser;
	}
