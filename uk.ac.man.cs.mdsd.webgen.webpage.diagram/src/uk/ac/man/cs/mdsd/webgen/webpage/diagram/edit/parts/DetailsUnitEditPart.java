...
import uk.ac.man.cs.mdsd.webgen.webpage.diagram.edit.policies.DetailsUnitItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DetailsUnitEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public DetailsUnitEditPart(View view) {
		super(view);
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DetailsUnitNameEditPart) {
			((DetailsUnitNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureUnitNameLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebuiVisualIDRegistry.getType(DetailsUnitNameEditPart.VISUAL_ID));
	}
