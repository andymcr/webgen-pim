 ...
 * @generated
 */
public class CreateUnitNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CreateUnitNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WebuiParserProvider.getParser(WebuiElementTypes.CreateUnit_3001, getParserElement(),
					WebuiVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.webpage.diagram.edit.parts.CreateUnitNameEditPart.VISUAL_ID));
		}
		return parser;
	}
