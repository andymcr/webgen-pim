...
import uk.ac.man.cs.mdsd.webgen.webpage.diagram.edit.policies.GalleryUnitItemSemanticEditPolicy;
...
public class GalleryUnitEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GalleryUnitNameEditPart) {
			((GalleryUnitNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureUnitNameLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebuiVisualIDRegistry.getType(GalleryUnitNameEditPart.VISUAL_ID));
	}
