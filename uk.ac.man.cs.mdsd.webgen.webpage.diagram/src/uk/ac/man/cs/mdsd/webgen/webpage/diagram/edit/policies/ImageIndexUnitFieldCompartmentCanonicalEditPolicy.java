 ...
 * @generated
 */
public class ImageIndexUnitFieldCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WebuiNodeDescriptor> childDescriptors = WebuiDiagramUpdater
				.getImageIndexUnitFieldCompartment_7006SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == UnitAssociation5EditPart.VISUAL_ID || visualID == UnitElement5EditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<WebuiNodeDescriptor> childDescriptors = WebuiDiagramUpdater
				.getImageIndexUnitFieldCompartment_7006SemanticChildren((View) getHost().getModel());
