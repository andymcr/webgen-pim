...
public class CallableImpl extends MinimalEObjectImpl.Container implements Callable {
	...
	protected EClass eStaticClass() {
		return BasePackage.Literals.CALLABLE;
	}
	...
	public EList<FormalParameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentWithInverseEList<FormalParameter>(FormalParameter.class, this, BasePackage.CALLABLE__PARAMETERS, BasePackage.FORMAL_PARAMETER__FORMAL_FOR);
		}
		return parameters;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Expression.class) {
			switch (derivedFeatureID) {
				case BasePackage.CALLABLE__ROOT_CONTAINER: return ExpressionPackage.EXPRESSION__ROOT_CONTAINER;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Expression.class) {
			switch (baseFeatureID) {
				case ExpressionPackage.EXPRESSION__ROOT_CONTAINER: return BasePackage.CALLABLE__ROOT_CONTAINER;
				default: return -1;
			}
		}
		if (baseClass == Operand.class) {
