...
public class ServiceFeatureReferenceImpl extends MinimalEObjectImpl.Container implements ServiceFeatureReference {
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate NAME__ESETTING_DELEGATE = ((EStructuralFeature.Internal)ServicePackage.Literals.SERVICE_FEATURE_REFERENCE__NAME).getSettingDelegate();
	 ...
	 * @generated
	 */
	protected ServiceFeatureReferenceImpl() {
		super();
	}
		...
		if (feature != null && feature.eIsProxy()) {
			...
			if (feature != oldFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ServicePackage.SERVICE_FEATURE_REFERENCE__FEATURE, oldFeature, feature));
			}
		}
		return feature;
	}
	...
	public void setFeature(Feature newFeature) {
		...
		feature = newFeature;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.SERVICE_FEATURE_REFERENCE__FEATURE, oldFeature, feature));
	}
