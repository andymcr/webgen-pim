		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DateCardsUnit_styleClass_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DateCardsUnit_styleClass_feature", "_UI_DateCardsUnit_type"),
				 WebuiPackage.Literals.DATE_CARDS_UNIT__STYLE_CLASS,
				 true,
				 false,
				 false,
