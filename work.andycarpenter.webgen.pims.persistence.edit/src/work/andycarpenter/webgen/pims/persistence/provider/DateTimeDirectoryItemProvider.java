...
/**
 * This is the item provider adapter for a {@link work.andycarpenter.webgen.pims.persistence.DateTimeDirectory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DateTimeDirectoryItemProvider extends DirectoryNamerItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PersistencePackage.Literals.DATE_TIME_DIRECTORY__FORMAT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PersistencePackage.Literals.DATE_TIME_DIRECTORY__ATTRIBUTE,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DateTimeDirectory.class)) {
			case PersistencePackage.DATE_TIME_DIRECTORY__FORMAT:
