...
/**
 * This is the item provider adapter for a {@link work.andycarpenter.webgen.pims.persistence.HashNamer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HashNamerItemProvider extends FileNamerItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PersistencePackage.Literals.HASH_NAMER__ALGORITHM,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PersistencePackage.Literals.HASH_NAMER__LENGTH,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HashNamer.class)) {
			case PersistencePackage.HASH_NAMER__ALGORITHM:
			case PersistencePackage.HASH_NAMER__LENGTH:
