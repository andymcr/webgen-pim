...
public class ServiceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ServiceParserProvider.getParser(ServiceElementTypes.Service_2001, getParserElement(),
					ServiceVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.service.diagram.edit.parts.ServiceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
