 ...
 * @generated
 */
public class ServiceModelingAssistantProviderOfServiceEditPart extends ServiceModelingAssistantProvider {
	...
	*/
	...
	public List<IElementType> getTypesForPopupBar(IAdaptable host) {
		...
		types.add(ServiceElementTypes.Selection_3001);
		types.add(ServiceElementTypes.BusinessOperation_3002);
		return types;
	}
