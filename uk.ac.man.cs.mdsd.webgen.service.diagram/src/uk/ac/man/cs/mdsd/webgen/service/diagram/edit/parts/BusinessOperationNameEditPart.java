...
import uk.ac.man.cs.mdsd.webgen.service.diagram.edit.policies.ServiceTextSelectionEditPolicy;
 ...
 * @generated
 */
public class BusinessOperationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BusinessOperationNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new ServiceTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return ServiceElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ServiceParserProvider.getParser(ServiceElementTypes.BusinessOperation_3002, getParserElement(),
					ServiceVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.service.diagram.edit.parts.BusinessOperationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, ServiceEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
