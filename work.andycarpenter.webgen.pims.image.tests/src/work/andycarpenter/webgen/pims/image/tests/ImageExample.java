...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>image</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ImageExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ImagePackage.eNS_URI, 
			 ImagePackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.image"));
				Image root = ImageFactory.eINSTANCE.createImage();
