 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ChildPathImpl#getParent <em>Parent</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ChildPathImpl extends MinimalEObjectImpl.Container implements ChildPath {
	...
	public PathAssociation getParent() {
		if (eContainerFeatureID() != WebuiPackage.CHILD_PATH__PARENT) return null;
	...
	public NotificationChain basicSetParent(PathAssociation newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, WebuiPackage.CHILD_PATH__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(PathAssociation newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != WebuiPackage.CHILD_PATH__PARENT && newParent != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, WebuiPackage.CHILD_PATH__PARENT, newParent, newParent));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebuiPackage.CHILD_PATH__PARENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
