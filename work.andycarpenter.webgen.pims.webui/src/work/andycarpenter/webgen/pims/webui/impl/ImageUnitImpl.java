 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#getContentType <em>Content Type</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#getSelection <em>Selection</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#getFindContainerSelection <em>Find Container Selection</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#isOmitContainerLoad <em>Omit Container Load</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#getFindElementSelection <em>Find Element Selection</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#getFilter <em>Filter</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#getSupportedFilters <em>Supported Filters</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#getBadges <em>Badges</em>}</li>
 ...
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#getNextPageIconName <em>Next Page Icon Name</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#getPreviousPageLabel <em>Previous Page Label</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#getPreviousPageIconName <em>Previous Page Icon Name</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#isUseDisabledPageLinks <em>Use Disabled Page Links</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#isUseFirstLastPageLinks <em>Use First Last Page Links</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#getFirstPageLabel <em>First Page Label</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#getFirstPageIconName <em>First Page Icon Name</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#getLastPageLabel <em>Last Page Label</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#getLastPageIconName <em>Last Page Icon Name</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#getPaginationClass <em>Pagination Class</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#getPaginationElementClass <em>Pagination Element Class</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ImageUnitImpl#getTitle <em>Title</em>}</li>
