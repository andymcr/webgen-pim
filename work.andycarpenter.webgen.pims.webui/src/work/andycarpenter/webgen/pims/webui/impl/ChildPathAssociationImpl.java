 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ChildPathAssociationImpl#getParent <em>Parent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChildPathAssociationImpl extends PathAssociationImpl implements ChildPathAssociation {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public PathAssociation getParent() {
		if (eContainerFeatureID() != WebuiPackage.CHILD_PATH_ASSOCIATION__PARENT) return null;
	...
	public NotificationChain basicSetParent(PathAssociation newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, WebuiPackage.CHILD_PATH_ASSOCIATION__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(PathAssociation newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != WebuiPackage.CHILD_PATH_ASSOCIATION__PARENT && newParent != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, WebuiPackage.CHILD_PATH_ASSOCIATION__PARENT, newParent, newParent));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebuiPackage.CHILD_PATH_ASSOCIATION__PARENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ChildPath.class) {
			switch (derivedFeatureID) {
				case WebuiPackage.CHILD_PATH_ASSOCIATION__PARENT: return WebuiPackage.CHILD_PATH__PARENT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ChildPath.class) {
			switch (baseFeatureID) {
				case WebuiPackage.CHILD_PATH__PARENT: return WebuiPackage.CHILD_PATH_ASSOCIATION__PARENT;
				default: return -1;
			}
		}
