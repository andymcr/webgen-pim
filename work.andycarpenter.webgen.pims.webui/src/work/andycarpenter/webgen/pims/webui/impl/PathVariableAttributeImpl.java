...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Path Variable Attribute</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.PathVariableAttributeImpl#getSuffixes <em>Suffixes</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.PathVariableAttributeImpl#getRootContainer <em>Root Container</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.PathVariableAttributeImpl#isUseContainerAsContext <em>Use Container As Context</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.PathVariableAttributeImpl#getContext <em>Context</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PathVariableAttributeImpl extends PathAttributeImpl implements PathVariableAttribute {
	/**
	 ...
	 * @generated
	 */
	protected PathVariableAttributeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return WebuiPackage.Literals.PATH_VARIABLE_ATTRIBUTE;
	}
	...
	public EList<String> getSuffixes() {
		if (suffixes == null) {
			suffixes = new EDataTypeUniqueEList<String>(String.class, this, WebuiPackage.PATH_VARIABLE_ATTRIBUTE__SUFFIXES);
		}
		return suffixes;
	}
	...
	public void setUseContainerAsContext(boolean newUseContainerAsContext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebuiPackage.PATH_VARIABLE_ATTRIBUTE__USE_CONTAINER_AS_CONTEXT, oldUseContainerAsContext, useContainerAsContext));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebuiPackage.PATH_VARIABLE_ATTRIBUTE__SUFFIXES:
				return getSuffixes();
			case WebuiPackage.PATH_VARIABLE_ATTRIBUTE__ROOT_CONTAINER:
				if (resolve) return getRootContainer();
				return basicGetRootContainer();
			case WebuiPackage.PATH_VARIABLE_ATTRIBUTE__USE_CONTAINER_AS_CONTEXT:
				return isUseContainerAsContext();
			case WebuiPackage.PATH_VARIABLE_ATTRIBUTE__CONTEXT:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Expression.class) {
			switch (derivedFeatureID) {
				case WebuiPackage.PATH_VARIABLE_ATTRIBUTE__SUFFIXES: return ExpressionPackage.EXPRESSION__SUFFIXES;
				case WebuiPackage.PATH_VARIABLE_ATTRIBUTE__ROOT_CONTAINER: return ExpressionPackage.EXPRESSION__ROOT_CONTAINER;
				default: return -1;
			}
		}
		...
		if (baseClass == PathVariable.class) {
			switch (derivedFeatureID) {
				case WebuiPackage.PATH_VARIABLE_ATTRIBUTE__USE_CONTAINER_AS_CONTEXT: return WebuiPackage.PATH_VARIABLE__USE_CONTAINER_AS_CONTEXT;
				case WebuiPackage.PATH_VARIABLE_ATTRIBUTE__CONTEXT: return WebuiPackage.PATH_VARIABLE__CONTEXT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Expression.class) {
			switch (baseFeatureID) {
				case ExpressionPackage.EXPRESSION__SUFFIXES: return WebuiPackage.PATH_VARIABLE_ATTRIBUTE__SUFFIXES;
				case ExpressionPackage.EXPRESSION__ROOT_CONTAINER: return WebuiPackage.PATH_VARIABLE_ATTRIBUTE__ROOT_CONTAINER;
				default: return -1;
			}
		}
		if (baseClass == Variable.class) {
		...
		if (baseClass == PathVariable.class) {
			switch (baseFeatureID) {
				case WebuiPackage.PATH_VARIABLE__USE_CONTAINER_AS_CONTEXT: return WebuiPackage.PATH_VARIABLE_ATTRIBUTE__USE_CONTAINER_AS_CONTEXT;
				case WebuiPackage.PATH_VARIABLE__CONTEXT: return WebuiPackage.PATH_VARIABLE_ATTRIBUTE__CONTEXT;
				default: return -1;
			}
		}
