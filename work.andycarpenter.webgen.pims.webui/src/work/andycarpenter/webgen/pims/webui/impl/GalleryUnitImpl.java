 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.GalleryUnitImpl#getImagePathFeature <em>Image Path Feature</em>}</li>
 ...
 * @generated
 */
public class GalleryUnitImpl extends CollectionUnitImpl implements GalleryUnit {
	/**
	...
	public void setImagePathFeature(DisplayValue newImagePathFeature) {
		if (newImagePathFeature != imagePathFeature) {
			...
			if (imagePathFeature != null)
				msgs = ((InternalEObject)imagePathFeature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WebuiPackage.GALLERY_UNIT__IMAGE_PATH_FEATURE, null, msgs);
			if (newImagePathFeature != null)
				msgs = ((InternalEObject)newImagePathFeature).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WebuiPackage.GALLERY_UNIT__IMAGE_PATH_FEATURE, null, msgs);
			msgs = basicSetImagePathFeature(newImagePathFeature, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebuiPackage.GALLERY_UNIT__IMAGE_PATH_FEATURE, newImagePathFeature, newImagePathFeature));
	}
	...
	public void setMissingImagePath(String newMissingImagePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebuiPackage.GALLERY_UNIT__MISSING_IMAGE_PATH, oldMissingImagePath, missingImagePath));
	}
	...
	public NotificationChain basicSetShowMissingImageWhen(Predicate newShowMissingImageWhen, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebuiPackage.GALLERY_UNIT__SHOW_MISSING_IMAGE_WHEN, oldShowMissingImageWhen, newShowMissingImageWhen);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setShowMissingImageWhen(Predicate newShowMissingImageWhen) {
		if (newShowMissingImageWhen != showMissingImageWhen) {
			...
			if (showMissingImageWhen != null)
				msgs = ((InternalEObject)showMissingImageWhen).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WebuiPackage.GALLERY_UNIT__SHOW_MISSING_IMAGE_WHEN, null, msgs);
			if (newShowMissingImageWhen != null)
				msgs = ((InternalEObject)newShowMissingImageWhen).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WebuiPackage.GALLERY_UNIT__SHOW_MISSING_IMAGE_WHEN, null, msgs);
			msgs = basicSetShowMissingImageWhen(newShowMissingImageWhen, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebuiPackage.GALLERY_UNIT__SHOW_MISSING_IMAGE_WHEN, newShowMissingImageWhen, newShowMissingImageWhen));
	}
	...
	public ImageManipulation getImageFilter() {
		if (imageFilter != null && imageFilter.eIsProxy()) {
			...
			if (imageFilter != oldImageFilter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebuiPackage.GALLERY_UNIT__IMAGE_FILTER, oldImageFilter, imageFilter));
			}
		}
		return imageFilter;
	}
	...
	public void setImageFilter(ImageManipulation newImageFilter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebuiPackage.GALLERY_UNIT__IMAGE_FILTER, oldImageFilter, imageFilter));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case WebuiPackage.GALLERY_UNIT__SHOW_MISSING_IMAGE_WHEN:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ImageUnit.class) {
			switch (derivedFeatureID) {
				case WebuiPackage.GALLERY_UNIT__IMAGE_PATH_FEATURE: return WebuiPackage.IMAGE_UNIT__IMAGE_PATH_FEATURE;
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ImageUnit.class) {
			switch (baseFeatureID) {
				case WebuiPackage.IMAGE_UNIT__IMAGE_PATH_FEATURE: return WebuiPackage.GALLERY_UNIT__IMAGE_PATH_FEATURE;
