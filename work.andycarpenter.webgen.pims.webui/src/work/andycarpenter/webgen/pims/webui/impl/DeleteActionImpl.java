 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.DeleteActionImpl#getDestination <em>Destination</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.DeleteActionImpl#getConfirmMessage <em>Confirm Message</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.DeleteActionImpl#getRequiresRole <em>Requires Role</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.DeleteActionImpl#getEnableWhen <em>Enable When</em>}</li>
...
public class DeleteActionImpl extends InlineActionImpl implements DeleteAction {
		...
		if (destination != null && destination.eIsProxy()) {
			...
			if (destination != oldDestination) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebuiPackage.DELETE_ACTION__DESTINATION, oldDestination, destination));
			}
		}
		return destination;
	}
	...
	public void setDestination(Page newDestination) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebuiPackage.DELETE_ACTION__DESTINATION, oldDestination, destination));
	}
	...
	public void setConfirmMessage(String newConfirmMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebuiPackage.DELETE_ACTION__CONFIRM_MESSAGE, oldConfirmMessage, confirmMessage));
	}
