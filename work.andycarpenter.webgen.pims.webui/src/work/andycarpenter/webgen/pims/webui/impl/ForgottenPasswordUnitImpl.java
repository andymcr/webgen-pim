 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getName <em>Name</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getDisplayLabel <em>Display Label</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getDisplayedOn <em>Displayed On</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#isCreateDefaultUriElement <em>Create Default Uri Element</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getRouteActuals <em>Route Actuals</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getRequiresRole <em>Requires Role</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getPurposeSummary <em>Purpose Summary</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getUriElement <em>Uri Element</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getAlternative <em>Alternative</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#isOmitCaption <em>Omit Caption</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getCaptionClass <em>Caption Class</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getPageDisplayedOn <em>Page Displayed On</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getDisplayFields <em>Display Fields</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getServicesUsed <em>Services Used</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getHideWhen <em>Hide When</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getMessageWhenHidden <em>Message When Hidden</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getSupportActions <em>Support Actions</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getHeader <em>Header</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getFooter <em>Footer</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getHeaderClass <em>Header Class</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getControlClass <em>Control Class</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getFooterClass <em>Footer Class</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getErrorClass <em>Error Class</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getSubmitLabel <em>Submit Label</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getCancelDestination <em>Cancel Destination</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getCancelLabel <em>Cancel Label</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getContentClass <em>Content Class</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.ForgottenPasswordUnitImpl#getStyleClass <em>Style Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForgottenPasswordUnitImpl extends MinimalEObjectImpl.Container implements ForgottenPasswordUnit {
	...
	public EList<RouteActual> getRouteActuals() {
		if (routeActuals == null) {
			routeActuals = new EObjectContainmentWithInverseEList<RouteActual>(RouteActual.class, this, WebuiPackage.FORGOTTEN_PASSWORD_UNIT__ROUTE_ACTUALS, WebuiPackage.ROUTE_ACTUAL__ACTUAL_FOR);
		}
		return routeActuals;
	}
	...
	public EList<Service> getServicesUsed() {
		if (servicesUsed == null) {
			servicesUsed = new EObjectResolvingEList<Service>(Service.class, this, WebuiPackage.FORGOTTEN_PASSWORD_UNIT__SERVICES_USED);
		}
		return servicesUsed;
	}
	...
	public NotificationChain basicSetHideWhen(Predicate newHideWhen, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebuiPackage.FORGOTTEN_PASSWORD_UNIT__HIDE_WHEN, oldHideWhen, newHideWhen);
	...
	public void setHideWhen(Predicate newHideWhen) {
		if (newHideWhen != hideWhen) {
			NotificationChain msgs = null;
			if (hideWhen != null)
				msgs = ((InternalEObject)hideWhen).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WebuiPackage.FORGOTTEN_PASSWORD_UNIT__HIDE_WHEN, null, msgs);
			if (newHideWhen != null)
				msgs = ((InternalEObject)newHideWhen).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WebuiPackage.FORGOTTEN_PASSWORD_UNIT__HIDE_WHEN, null, msgs);
			msgs = basicSetHideWhen(newHideWhen, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebuiPackage.FORGOTTEN_PASSWORD_UNIT__HIDE_WHEN, newHideWhen, newHideWhen));
	}
	...
	public void setMessageWhenHidden(String newMessageWhenHidden) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebuiPackage.FORGOTTEN_PASSWORD_UNIT__MESSAGE_WHEN_HIDDEN, oldMessageWhenHidden, messageWhenHidden));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WebuiPackage.FORGOTTEN_PASSWORD_UNIT__SERVICES_USED:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ContentUnit.class) {
			switch (derivedFeatureID) {
				...
				case WebuiPackage.FORGOTTEN_PASSWORD_UNIT__ROUTE_ACTUALS: return WebuiPackage.CONTENT_UNIT__ROUTE_ACTUALS;
		...
		if (baseClass == DynamicUnit.class) {
			switch (derivedFeatureID) {
				...
				case WebuiPackage.FORGOTTEN_PASSWORD_UNIT__SERVICES_USED: return WebuiPackage.DYNAMIC_UNIT__SERVICES_USED;
				case WebuiPackage.FORGOTTEN_PASSWORD_UNIT__HIDE_WHEN: return WebuiPackage.DYNAMIC_UNIT__HIDE_WHEN;
				case WebuiPackage.FORGOTTEN_PASSWORD_UNIT__MESSAGE_WHEN_HIDDEN: return WebuiPackage.DYNAMIC_UNIT__MESSAGE_WHEN_HIDDEN;
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ContentUnit.class) {
			switch (baseFeatureID) {
				...
				case WebuiPackage.CONTENT_UNIT__ROUTE_ACTUALS: return WebuiPackage.FORGOTTEN_PASSWORD_UNIT__ROUTE_ACTUALS;
		...
		if (baseClass == DynamicUnit.class) {
			switch (baseFeatureID) {
				...
				case WebuiPackage.DYNAMIC_UNIT__SERVICES_USED: return WebuiPackage.FORGOTTEN_PASSWORD_UNIT__SERVICES_USED;
				case WebuiPackage.DYNAMIC_UNIT__HIDE_WHEN: return WebuiPackage.FORGOTTEN_PASSWORD_UNIT__HIDE_WHEN;
				case WebuiPackage.DYNAMIC_UNIT__MESSAGE_WHEN_HIDDEN: return WebuiPackage.FORGOTTEN_PASSWORD_UNIT__MESSAGE_WHEN_HIDDEN;
