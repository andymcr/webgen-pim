 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.DateFieldImpl#getDetails <em>Details</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.DateFieldImpl#getFormat <em>Format</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DateFieldImpl extends InterfaceFieldImpl implements DateField {
	...
	protected EClass eStaticClass() {
		return WebuiPackage.Literals.DATE_FIELD;
	}
	...
	public void setDetails(DateDetails newDetails) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebuiPackage.DATE_FIELD__DETAILS, oldDetails, details));
	}
	...
	public void setFormat(String newFormat) {
		...
		format = newFormat;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebuiPackage.DATE_FIELD__FORMAT, oldFormat, format));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebuiPackage.DATE_FIELD__DETAILS:
				return getDetails();
			case WebuiPackage.DATE_FIELD__FORMAT:
				return getFormat();
		}
