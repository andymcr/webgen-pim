...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Tabular Unit Styles</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.TabularUnitStylesImpl#getHeaderClass <em>Header Class</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.TabularUnitStylesImpl#getFooterClass <em>Footer Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TabularUnitStylesImpl extends CollectionStylesImpl implements TabularUnitStyles {
	 ...
	 * @generated
	 */
	protected TabularUnitStylesImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return WebuiPackage.Literals.TABULAR_UNIT_STYLES;
	}
	...
	public void setHeaderClass(String newHeaderClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebuiPackage.TABULAR_UNIT_STYLES__HEADER_CLASS, oldHeaderClass, headerClass));
	}
	...
	public void setFooterClass(String newFooterClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebuiPackage.TABULAR_UNIT_STYLES__FOOTER_CLASS, oldFooterClass, footerClass));
	}
