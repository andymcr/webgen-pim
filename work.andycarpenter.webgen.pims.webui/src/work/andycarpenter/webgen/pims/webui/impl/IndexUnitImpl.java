 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.IndexUnitImpl#getContentType <em>Content Type</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.IndexUnitImpl#getSelection <em>Selection</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.IndexUnitImpl#getFindContainerSelection <em>Find Container Selection</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.IndexUnitImpl#isOmitContainerLoad <em>Omit Container Load</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.IndexUnitImpl#getFindElementSelection <em>Find Element Selection</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.IndexUnitImpl#getFilter <em>Filter</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.IndexUnitImpl#getSupportedFilters <em>Supported Filters</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.IndexUnitImpl#getBadges <em>Badges</em>}</li>
 ...
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.IndexUnitImpl#getNextPageIconName <em>Next Page Icon Name</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.IndexUnitImpl#getPreviousPageLabel <em>Previous Page Label</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.IndexUnitImpl#getPreviousPageIconName <em>Previous Page Icon Name</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.IndexUnitImpl#isUseDisabledPageLinks <em>Use Disabled Page Links</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.IndexUnitImpl#isUseFirstLastPageLinks <em>Use First Last Page Links</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.IndexUnitImpl#getFirstPageLabel <em>First Page Label</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.IndexUnitImpl#getFirstPageIconName <em>First Page Icon Name</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.IndexUnitImpl#getLastPageLabel <em>Last Page Label</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.IndexUnitImpl#getLastPageIconName <em>Last Page Icon Name</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.IndexUnitImpl#getPaginationClass <em>Pagination Class</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.webui.impl.IndexUnitImpl#getPaginationElementClass <em>Pagination Element Class</em>}</li>
