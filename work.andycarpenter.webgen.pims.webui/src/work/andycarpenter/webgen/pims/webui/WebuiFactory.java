...
public interface WebuiFactory extends EFactory {
	 ...
	 * @generated
	 */
	WebuiFactory eINSTANCE = work.andycarpenter.webgen.pims.webui.impl.WebuiFactoryImpl.init();
	...
	/**
	 * Returns a new object of class '<em>Reset Password Unit</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Reset Password Unit</em>'.
	 * @generated
	 */
