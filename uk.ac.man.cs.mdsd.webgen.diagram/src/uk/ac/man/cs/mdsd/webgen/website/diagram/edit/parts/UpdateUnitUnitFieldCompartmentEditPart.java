 ...
 * @generated
 */
public class UpdateUnitUnitFieldCompartmentEditPart extends
	...
	public String getCompartmentName() {
		return Messages.UpdateUnitUnitFieldCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new UpdateUnitUnitFieldCompartmentItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new UpdateUnitUnitFieldCompartmentCanonicalEditPolicy());
