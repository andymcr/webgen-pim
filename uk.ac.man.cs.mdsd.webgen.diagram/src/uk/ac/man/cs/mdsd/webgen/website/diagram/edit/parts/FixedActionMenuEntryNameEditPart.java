 ...
 * @generated
 */
public class FixedActionMenuEntryNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public FixedActionMenuEntryNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WebsiteParserProvider
					.getParser(
							WebsiteElementTypes.FixedActionMenuEntry_3159,
							getParserElement(),
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.FixedActionMenuEntryNameEditPart.VISUAL_ID));
		}
		return parser;
	}
