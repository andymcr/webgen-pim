...
public class ServiceEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ServiceNameEditPart) {
			((ServiceNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureServiceNameLabelFigure());
			return true;
		}
		return false;
	}
	...
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(125, 60);
		return result;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(ServiceNameEditPart.VISUAL_ID));
	}
	...
	*/
	...
	public class ServiceFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureServiceNameLabelFigure;
		...
		private void createContents() {
			...
			fFigureServiceNameLabelFigure = new WrappingLabel();

			fFigureServiceNameLabelFigure.setText("");

			this.add(fFigureServiceNameLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureServiceNameLabelFigure() {
			return fFigureServiceNameLabelFigure;
		}
