 ...
 * @generated
 */
public class DeleteActionNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DeleteActionNameEditPart(View view) {
		super(view);
	}
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.DeleteActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
