...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DetailsUnit5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DetailsUnit5EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DetailsUnit5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DetailsUnit5ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DetailsUnitName5EditPart) {
			((DetailsUnitName5EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DetailsUnitName5EditPart.VISUAL_ID));
	}
