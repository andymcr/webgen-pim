 ...
 * @generated
 */
public class CreateUnitUnitFieldCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getCreateUnitUnitFieldCompartment_7042SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getCreateUnitUnitFieldCompartment_7042SemanticChildren((View) getHost().getModel());
