...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitAssociation9ItemSemanticEditPolicy;
...
public class UnitAssociation9EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitAssociationName9EditPart) {
			((UnitAssociationName9EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitAssociationName9EditPart.VISUAL_ID));
	}
