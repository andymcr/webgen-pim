...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.ModelLabelY2ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class ModelLabelY2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public ModelLabelY2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ModelLabelY2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ModelLabelYName2EditPart) {
			((ModelLabelYName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureModelLabelNameLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(ModelLabelYName2EditPart.VISUAL_ID));
	}
