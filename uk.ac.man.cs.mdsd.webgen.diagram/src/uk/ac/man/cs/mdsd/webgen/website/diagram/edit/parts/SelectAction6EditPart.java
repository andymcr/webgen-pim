...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.SelectAction6ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class SelectAction6EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public SelectAction6EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SelectAction6ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SelectActionName6EditPart) {
			((SelectActionName6EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActionNameLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(SelectActionName6EditPart.VISUAL_ID));
	}
