 ...
 * @generated
 */
public class GalleryUnitActionCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getGalleryUnitActionCompartment_7134SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getGalleryUnitActionCompartment_7134SemanticChildren((View) getHost().getModel());
