...
public class EncapsulatedAttributeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WebsiteParserProvider.getParser(WebsiteElementTypes.EncapsulatedAttribute_3282, getParserElement(),
					WebsiteVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.EncapsulatedAttributeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
