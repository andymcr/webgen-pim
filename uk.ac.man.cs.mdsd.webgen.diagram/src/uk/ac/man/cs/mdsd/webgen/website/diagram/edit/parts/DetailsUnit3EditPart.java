...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DetailsUnit3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DetailsUnit3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DetailsUnit3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DetailsUnit3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DetailsUnitName3EditPart) {
			((DetailsUnitName3EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DetailsUnitName3EditPart.VISUAL_ID));
	}
