...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.IndexUnit6ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IndexUnit6EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public IndexUnit6EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IndexUnit6ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof IndexUnitName6EditPart) {
			((IndexUnitName6EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(IndexUnitName6EditPart.VISUAL_ID));
	}
