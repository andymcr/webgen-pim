...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DeleteAction6ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class DeleteAction6EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public DeleteAction6EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DeleteAction6ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DeleteActionName6EditPart) {
			((DeleteActionName6EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActionNameLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DeleteActionName6EditPart.VISUAL_ID));
	}
