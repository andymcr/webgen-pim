 ...
 * @generated
 */
public class DetailsUnitNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.DetailsUnitNameEditPart.VISUAL_ID));
		}
		return parser;
	}
