 ...
 * @generated
 */
public class UnitAssociationName4EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitAssociationName4EditPart.VISUAL_ID));
		}
		return parser;
	}
