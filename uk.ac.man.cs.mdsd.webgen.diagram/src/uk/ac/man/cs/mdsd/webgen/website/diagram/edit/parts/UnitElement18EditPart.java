...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitElement18ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class UnitElement18EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public UnitElement18EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new UnitElement18ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitElementName18EditPart) {
			((UnitElementName18EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitElementName18EditPart.VISUAL_ID));
	}
