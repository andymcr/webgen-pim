 ...
 * @generated
 */
public class UnitAssociationName13EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public UnitAssociationName13EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WebsiteParserProvider.getParser(WebsiteElementTypes.UnitAssociation_3196, getParserElement(),
					WebsiteVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitAssociationName13EditPart.VISUAL_ID));
		}
		return parser;
	}
