 ...
 * @generated
 */
public class CommandUnitCommandsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return UserCommandEditPart.VISUAL_ID == WebsiteVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getCommandUnitCommandsCompartment_7117SemanticChildren((View) getHost()
						.getModel());
