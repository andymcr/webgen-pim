 ...
 * @generated
 */
public class ViewAssociationCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ViewAssociationCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof View) {
			return false;
		}
		if (target != null && false == target instanceof EncapsulatedAssociation) {
			return false;
		}
		if (getSource() == null) {
	...
	* @generated
	*/
	protected void doConfigure(ViewAssociation newElement, IProgressMonitor monitor, IAdaptable info)
	...
	* @generated
	*/
	protected EncapsulatedAssociation getTarget() {
		return (EncapsulatedAssociation) target;
	}
