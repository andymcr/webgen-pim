...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DateField2ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class DateField2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DateField2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DateField2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DateFieldName2EditPart) {
			((DateFieldName2EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DateFieldName2EditPart.VISUAL_ID));
	}
