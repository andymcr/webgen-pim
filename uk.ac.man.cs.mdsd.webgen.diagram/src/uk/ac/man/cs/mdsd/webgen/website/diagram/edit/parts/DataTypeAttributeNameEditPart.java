 ...
 * @generated
 */
public class DataTypeAttributeNameEditPart extends CompartmentEditPart
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.DataTypeAttributeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
