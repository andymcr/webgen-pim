 ...
 * @generated
 */
public class LocationAttributeNameEditPart extends CompartmentEditPart
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.LocationAttributeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
