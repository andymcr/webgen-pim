 ...
 * @generated
 */
public class WebsitePropertiesSiteTitleEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public WebsitePropertiesSiteTitleEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WebsiteParserProvider.getParser(WebsiteElementTypes.WebsiteProperties_2001, getParserElement(),
					WebsiteVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.WebsitePropertiesSiteTitleEditPart.VISUAL_ID));
		}
		return parser;
	}
