...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.SelectAction4ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class SelectAction4EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public SelectAction4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SelectAction4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SelectActionName4EditPart) {
			((SelectActionName4EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActionNameLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(SelectActionName4EditPart.VISUAL_ID));
	}
