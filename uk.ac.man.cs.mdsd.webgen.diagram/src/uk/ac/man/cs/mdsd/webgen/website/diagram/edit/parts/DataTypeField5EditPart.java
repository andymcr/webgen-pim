...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DataTypeField5ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class DataTypeField5EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DataTypeField5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DataTypeField5ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DataTypeFieldName5EditPart) {
			((DataTypeFieldName5EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DataTypeFieldName5EditPart.VISUAL_ID));
	}
