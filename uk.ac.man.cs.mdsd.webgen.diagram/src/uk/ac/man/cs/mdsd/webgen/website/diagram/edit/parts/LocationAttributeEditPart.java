...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.LocationAttributeItemSemanticEditPolicy;
...
public class LocationAttributeEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LocationAttributeNameEditPart) {
			((LocationAttributeNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(LocationAttributeNameEditPart.VISUAL_ID));
	}
