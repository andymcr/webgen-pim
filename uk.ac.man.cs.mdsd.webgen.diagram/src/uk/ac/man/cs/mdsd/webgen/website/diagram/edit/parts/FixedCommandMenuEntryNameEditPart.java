 ...
 * @generated
 */
public class FixedCommandMenuEntryNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WebsiteParserProvider.getParser(WebsiteElementTypes.FixedCommandMenuEntry_3231, getParserElement(),
					WebsiteVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.FixedCommandMenuEntryNameEditPart.VISUAL_ID));
		}
		return parser;
	}
