...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.IndexUnit7ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IndexUnit7EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public IndexUnit7EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IndexUnit7ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof IndexUnitName7EditPart) {
			((IndexUnitName7EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(IndexUnitName7EditPart.VISUAL_ID));
	}
