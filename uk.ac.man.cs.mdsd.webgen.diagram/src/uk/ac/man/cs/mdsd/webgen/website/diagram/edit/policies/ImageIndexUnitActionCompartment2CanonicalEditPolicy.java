 ...
 * @generated
 */
public class ImageIndexUnitActionCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getImageIndexUnitActionCompartment_7136SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == SelectAction9EditPart.VISUAL_ID || visualID == DeleteAction5EditPart.VISUAL_ID
				|| visualID == FeatureSupportAction3EditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getImageIndexUnitActionCompartment_7136SemanticChildren((View) getHost().getModel());
