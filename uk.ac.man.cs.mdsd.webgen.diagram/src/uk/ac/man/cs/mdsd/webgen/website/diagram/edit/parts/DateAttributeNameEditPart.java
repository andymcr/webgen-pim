 ...
 * @generated
 */
public class DateAttributeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.DateAttributeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
