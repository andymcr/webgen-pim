 ...
 * @generated
 */
public class SelectActionNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SelectActionNameEditPart(View view) {
		super(view);
	}
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.SelectActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
