 ...
 * @generated
 */
public class UnitElementName10EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitElementName10EditPart.VISUAL_ID));
		}
		return parser;
	}
