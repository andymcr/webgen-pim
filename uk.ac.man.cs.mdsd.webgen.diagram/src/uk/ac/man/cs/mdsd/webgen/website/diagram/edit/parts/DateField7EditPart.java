...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DateField7ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class DateField7EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DateField7EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DateField7ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DateFieldName7EditPart) {
			((DateFieldName7EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DateFieldName7EditPart.VISUAL_ID));
	}
