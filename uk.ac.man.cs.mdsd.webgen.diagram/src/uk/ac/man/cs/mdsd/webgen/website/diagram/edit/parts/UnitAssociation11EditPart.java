...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitAssociation11ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class UnitAssociation11EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public UnitAssociation11EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new UnitAssociation11ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitAssociationName11EditPart) {
			((UnitAssociationName11EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitAssociationName11EditPart.VISUAL_ID));
	}
