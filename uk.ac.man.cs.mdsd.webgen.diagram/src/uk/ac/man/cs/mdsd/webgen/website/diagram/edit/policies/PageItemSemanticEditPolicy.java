...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.commands.PageLinkCreateCommand;
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.commands.PageLinkReorientCommand;
...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.GridUnitEditPart;
 ...
 * @generated
 */
public class PageItemSemanticEditPolicy extends WebsiteBaseItemSemanticEditPolicy {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (WebsiteVisualIDRegistry.getVisualID(incomingLink) == PageLinkEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (WebsiteVisualIDRegistry.getVisualID(outgoingLink) == PageLinkEditPart.VISUAL_ID) {
