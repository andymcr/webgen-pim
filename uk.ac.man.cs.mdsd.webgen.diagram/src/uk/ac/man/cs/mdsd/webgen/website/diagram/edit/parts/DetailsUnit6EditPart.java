...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DetailsUnit6ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DetailsUnit6EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DetailsUnit6EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DetailsUnit6ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DetailsUnitName6EditPart) {
			((DetailsUnitName6EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DetailsUnitName6EditPart.VISUAL_ID));
	}
