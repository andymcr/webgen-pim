 ...
 * @generated
 */
public class IndexUnitActionCompartment3CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getIndexUnitActionCompartment_7086SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == SelectAction2EditPart.VISUAL_ID
				|| visualID == DeleteActionEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getIndexUnitActionCompartment_7086SemanticChildren((View) getHost()
						.getModel());
