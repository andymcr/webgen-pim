 ...
 * @generated
 */
public class IndexUnitActionCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == SelectAction6EditPart.VISUAL_ID
				|| visualID == DeleteAction2EditPart.VISUAL_ID
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getIndexUnitActionCompartment_7071SemanticChildren((View) getHost()
						.getModel());
