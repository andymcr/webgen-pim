...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitElement14ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class UnitElement14EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public UnitElement14EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new UnitElement14ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitElementName14EditPart) {
			((UnitElementName14EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitElementName14EditPart.VISUAL_ID));
	}
