 ...
 * @generated
 */
public class UnitElementName6EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitElementName6EditPart.VISUAL_ID));
		}
		return parser;
	}
