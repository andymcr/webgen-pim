 ...
 * @generated
 */
public class DetailsUnitUnitFieldCompartment5CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == UnitElement10EditPart.VISUAL_ID
				|| visualID == UnitAssociation8EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getDetailsUnitUnitFieldCompartment_7066SemanticChildren((View) getHost()
						.getModel());
