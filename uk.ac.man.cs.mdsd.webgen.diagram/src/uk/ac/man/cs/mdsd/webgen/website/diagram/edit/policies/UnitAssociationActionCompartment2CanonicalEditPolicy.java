 ...
 * @generated
 */
public class UnitAssociationActionCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getUnitAssociationActionCompartment_7176SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return SelectAction6EditPart.VISUAL_ID == WebsiteVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getUnitAssociationActionCompartment_7176SemanticChildren((View) getHost().getModel());
