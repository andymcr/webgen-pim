 ...
 * @generated
 */
public class UnitAssociationActionCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == DetailsUnit7EditPart.VISUAL_ID
				|| visualID == IndexUnit7EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getUnitAssociationInterfaceUnitsCompartment_7110SemanticChildren((View) getHost()
						.getModel());
