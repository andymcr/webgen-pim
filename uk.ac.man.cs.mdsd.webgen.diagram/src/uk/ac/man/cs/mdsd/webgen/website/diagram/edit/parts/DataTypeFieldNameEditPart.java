 ...
 * @generated
 */
public class DataTypeFieldNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DataTypeFieldNameEditPart(View view) {
		super(view);
	}
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.DataTypeFieldNameEditPart.VISUAL_ID));
		}
		return parser;
	}
