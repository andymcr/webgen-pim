 ...
 * @generated
 */
public class UnitAssociationInterfaceUnitCompartment3CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == DetailsUnit4EditPart.VISUAL_ID
				|| visualID == IndexUnit4EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getUnitAssociationInterfaceUnitsCompartment_7098SemanticChildren((View) getHost()
						.getModel());
