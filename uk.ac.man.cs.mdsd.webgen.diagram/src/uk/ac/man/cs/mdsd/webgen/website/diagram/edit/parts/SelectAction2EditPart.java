...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.SelectAction2ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class SelectAction2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public SelectAction2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SelectAction2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SelectActionName2EditPart) {
			((SelectActionName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActionNameLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(SelectActionName2EditPart.VISUAL_ID));
	}
