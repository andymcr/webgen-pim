...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DateField6ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class DateField6EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DateField6EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DateField6ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DateFieldName6EditPart) {
			((DateFieldName6EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DateFieldName6EditPart.VISUAL_ID));
	}
