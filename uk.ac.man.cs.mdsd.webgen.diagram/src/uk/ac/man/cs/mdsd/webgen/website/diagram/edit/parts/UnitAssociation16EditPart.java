...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitAssociation16ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class UnitAssociation16EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public UnitAssociation16EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new UnitAssociation16ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitAssociationName16EditPart) {
			((UnitAssociationName16EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitAssociationName16EditPart.VISUAL_ID));
	}
