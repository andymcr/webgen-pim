...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DetailsUnit4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DetailsUnit4EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DetailsUnit4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DetailsUnit4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DetailsUnitName4EditPart) {
			((DetailsUnitName4EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DetailsUnitName4EditPart.VISUAL_ID));
	}
