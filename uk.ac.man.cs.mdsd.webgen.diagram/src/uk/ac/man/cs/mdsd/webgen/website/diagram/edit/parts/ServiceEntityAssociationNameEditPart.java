 ...
 * @generated
 */
public class ServiceEntityAssociationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WebsiteParserProvider.getParser(WebsiteElementTypes.ServiceEntityAssociation_3168,
					getParserElement(), WebsiteVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.ServiceEntityAssociationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
