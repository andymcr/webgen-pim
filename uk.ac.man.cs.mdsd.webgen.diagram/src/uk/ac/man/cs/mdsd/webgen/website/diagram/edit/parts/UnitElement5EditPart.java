...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitElement5ItemSemanticEditPolicy;
...
public class UnitElement5EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitElementName5EditPart) {
			((UnitElementName5EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitElementName5EditPart.VISUAL_ID));
	}
