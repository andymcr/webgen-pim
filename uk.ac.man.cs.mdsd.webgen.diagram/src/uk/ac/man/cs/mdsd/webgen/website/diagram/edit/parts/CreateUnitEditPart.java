...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.CreateUnitItemSemanticEditPolicy;
...
public class CreateUnitEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CreateUnitNameEditPart) {
			((CreateUnitNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(CreateUnitNameEditPart.VISUAL_ID));
	}
