...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.FileAttributeItemSemanticEditPolicy;
...
public class FileAttributeEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FileAttributeNameEditPart) {
			((FileAttributeNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAttributeNameLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(FileAttributeNameEditPart.VISUAL_ID));
	}
