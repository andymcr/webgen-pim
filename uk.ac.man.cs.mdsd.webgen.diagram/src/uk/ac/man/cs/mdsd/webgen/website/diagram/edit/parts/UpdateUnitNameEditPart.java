 ...
 * @generated
 */
public class UpdateUnitNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UpdateUnitNameEditPart.VISUAL_ID));
		}
		return parser;
	}
