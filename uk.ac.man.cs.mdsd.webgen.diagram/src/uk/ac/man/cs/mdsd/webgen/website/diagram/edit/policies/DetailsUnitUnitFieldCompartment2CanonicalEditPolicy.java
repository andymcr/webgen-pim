 ...
 * @generated
 */
public class DetailsUnitUnitFieldCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == UnitElement5EditPart.VISUAL_ID
				|| visualID == UnitAssociation5EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getDetailsUnitUnitFieldCompartment_7051SemanticChildren((View) getHost()
						.getModel());
