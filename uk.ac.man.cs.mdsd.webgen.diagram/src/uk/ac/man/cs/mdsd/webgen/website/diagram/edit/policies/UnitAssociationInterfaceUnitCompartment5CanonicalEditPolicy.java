 ...
 * @generated
 */
public class UnitAssociationInterfaceUnitCompartment5CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == DetailsUnit6EditPart.VISUAL_ID
				|| visualID == IndexUnit5EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getUnitAssociationInterfaceUnitsCompartment_7108SemanticChildren((View) getHost()
						.getModel());
