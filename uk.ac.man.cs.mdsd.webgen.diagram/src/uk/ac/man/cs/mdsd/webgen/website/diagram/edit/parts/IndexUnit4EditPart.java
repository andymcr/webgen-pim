...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.IndexUnit4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IndexUnit4EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public IndexUnit4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IndexUnit4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof IndexUnitName4EditPart) {
			((IndexUnitName4EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(IndexUnitName4EditPart.VISUAL_ID));
	}
