 ...
 * @generated
 */
public class UnitAssociationName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitAssociationName2EditPart.VISUAL_ID));
		}
		return parser;
	}
