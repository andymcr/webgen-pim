...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.CreateUpdateUnit2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CreateUpdateUnit2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public CreateUpdateUnit2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CreateUpdateUnit2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CreateUpdateUnitName2EditPart) {
			((CreateUpdateUnitName2EditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(CreateUpdateUnitName2EditPart.VISUAL_ID));
	}
