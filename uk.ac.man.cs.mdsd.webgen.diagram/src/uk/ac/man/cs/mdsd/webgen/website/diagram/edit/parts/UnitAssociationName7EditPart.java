 ...
 * @generated
 */
public class UnitAssociationName7EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitAssociationName7EditPart.VISUAL_ID));
		}
		return parser;
	}
