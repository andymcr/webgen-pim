...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitElement5EditPart;
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitElement6EditPart;
 ...
 * @generated
 */
public class DetailsUnitUnitFieldCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getDetailsUnitUnitFieldCompartment_7053SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return UnitElement6EditPart.VISUAL_ID == WebsiteVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getDetailsUnitUnitFieldCompartment_7053SemanticChildren((View) getHost().getModel());
