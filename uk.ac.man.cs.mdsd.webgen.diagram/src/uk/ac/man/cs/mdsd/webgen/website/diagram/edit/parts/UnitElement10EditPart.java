...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitElement10ItemSemanticEditPolicy;
...
public class UnitElement10EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitElementName10EditPart) {
			((UnitElementName10EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitElementName10EditPart.VISUAL_ID));
	}
