 ...
 * @generated
 */
public class DetailsUnitActionCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return UnitSupportAction2EditPart.VISUAL_ID == WebsiteVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getDetailsUnitActionCompartment_7087SemanticChildren((View) getHost()
						.getModel());
