...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitAssociation13ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class UnitAssociation13EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public UnitAssociation13EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new UnitAssociation13ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitAssociationName13EditPart) {
			((UnitAssociationName13EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitAssociationName13EditPart.VISUAL_ID));
	}
