 ...
 * @generated
 */
public class IndexUnitUnitFieldCompartment8CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == UnitElement20EditPart.VISUAL_ID
				|| visualID == UnitAssociation18EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getIndexUnitUnitFieldCompartment_7115SemanticChildren((View) getHost()
						.getModel());
