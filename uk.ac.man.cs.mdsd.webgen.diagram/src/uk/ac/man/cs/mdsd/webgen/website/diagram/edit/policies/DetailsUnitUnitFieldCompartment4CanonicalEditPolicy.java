 ...
 * @generated
 */
public class DetailsUnitUnitFieldCompartment4CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == UnitElement9EditPart.VISUAL_ID
				|| visualID == UnitAssociation7EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getDetailsUnitUnitFieldCompartment_7056SemanticChildren((View) getHost()
						.getModel());
