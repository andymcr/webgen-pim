 ...
 * @generated
 */
public class ServiceModelLabelsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return ModelLabelEditPart.VISUAL_ID == WebsiteVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getServiceModelLabelsCompartment_7085SemanticChildren((View) getHost()
						.getModel());
