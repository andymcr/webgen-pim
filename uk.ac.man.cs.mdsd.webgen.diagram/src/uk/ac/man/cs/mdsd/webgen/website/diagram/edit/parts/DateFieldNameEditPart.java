 ...
 * @generated
 */
public class DateFieldNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DateFieldNameEditPart(View view) {
		super(view);
	}
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.DateFieldNameEditPart.VISUAL_ID));
		}
		return parser;
	}
