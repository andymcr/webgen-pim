 ...
 * @generated
 */
public class UnitAssociationInterfaceUnitCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == DetailsUnit2EditPart.VISUAL_ID
				|| visualID == IndexUnit2EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getUnitAssociationInterfaceUnitsCompartment_7096SemanticChildren((View) getHost()
						.getModel());
