 ...
 * @generated
 */
public class IndexUnitUnitFieldCompartment5CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == UnitElement14EditPart.VISUAL_ID
				|| visualID == UnitAssociation12EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getIndexUnitUnitFieldCompartment_7069SemanticChildren((View) getHost()
						.getModel());
