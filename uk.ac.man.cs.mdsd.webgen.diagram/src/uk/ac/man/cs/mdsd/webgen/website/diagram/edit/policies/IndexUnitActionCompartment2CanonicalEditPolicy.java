 ...
 * @generated
 */
public class IndexUnitActionCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getIndexUnitActionCompartment_7173SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getIndexUnitActionCompartment_7173SemanticChildren((View) getHost().getModel());
