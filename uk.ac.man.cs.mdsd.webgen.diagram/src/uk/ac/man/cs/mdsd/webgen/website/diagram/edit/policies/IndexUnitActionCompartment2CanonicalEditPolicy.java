 ...
 * @generated
 */
public class IndexUnitActionCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getIndexUnitActionCompartment_7116SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == SelectAction7EditPart.VISUAL_ID
				|| visualID == DeleteAction3EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getIndexUnitActionCompartment_7116SemanticChildren((View) getHost()
						.getModel());
