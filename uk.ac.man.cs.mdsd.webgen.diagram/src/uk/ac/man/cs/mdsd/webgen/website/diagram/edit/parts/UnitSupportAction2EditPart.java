...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitSupportAction2ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class UnitSupportAction2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public UnitSupportAction2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new UnitSupportAction2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitSupportActionName2EditPart) {
			((UnitSupportActionName2EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitSupportActionName2EditPart.VISUAL_ID));
	}
