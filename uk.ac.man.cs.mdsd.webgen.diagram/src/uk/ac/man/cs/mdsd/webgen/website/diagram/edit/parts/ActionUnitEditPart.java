...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.ActionUnitItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ActionUnitEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ActionUnitEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ActionUnitItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ActionUnitNameEditPart) {
			((ActionUnitNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(ActionUnitNameEditPart.VISUAL_ID));
	}
