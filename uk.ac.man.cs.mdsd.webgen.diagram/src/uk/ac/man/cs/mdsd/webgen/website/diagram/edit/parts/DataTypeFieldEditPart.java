...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DataTypeFieldItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class DataTypeFieldEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DataTypeFieldEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DataTypeFieldItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DataTypeFieldNameEditPart) {
			((DataTypeFieldNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DataTypeFieldNameEditPart.VISUAL_ID));
	}
