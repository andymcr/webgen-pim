	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case ActionUnitNameEditPart.VISUAL_ID:
				return new ActionUnitNameEditPart(view);
			...
			case CommandUnitEditPart.VISUAL_ID:
				return new CommandUnitEditPart(view);

			case CommandUnitNameEditPart.VISUAL_ID:
				return new CommandUnitNameEditPart(view);

			case UserCommandEditPart.VISUAL_ID:
				return new UserCommandEditPart(view);

			case UserCommandNameEditPart.VISUAL_ID:
				return new UserCommandNameEditPart(view);
			...
			case UnitSupportAction2EditPart.VISUAL_ID:
				return new UnitSupportAction2EditPart(view);

			case UnitSupportActionName2EditPart.VISUAL_ID:
				return new UnitSupportActionName2EditPart(view);
			...
			case UnitAssociation18EditPart.VISUAL_ID:
				return new UnitAssociation18EditPart(view);

			case UnitAssociationName18EditPart.VISUAL_ID:
				return new UnitAssociationName18EditPart(view);
			...
			case DataTypeField7EditPart.VISUAL_ID:
				return new DataTypeField7EditPart(view);

			case DataTypeFieldName7EditPart.VISUAL_ID:
				return new DataTypeFieldName7EditPart(view);

			case DateField7EditPart.VISUAL_ID:
				return new DateField7EditPart(view);
			...
			case FixedCommandMenuEntryNameEditPart.VISUAL_ID:
				return new FixedCommandMenuEntryNameEditPart(view);
			...
			case ServiceEntityElementEditPart.VISUAL_ID:
				return new ServiceEntityElementEditPart(view);

			case ServiceEntityElementNameEditPart.VISUAL_ID:
				return new ServiceEntityElementNameEditPart(view);

			case ServiceEntityAssociationEditPart.VISUAL_ID:
				return new ServiceEntityAssociationEditPart(view);

			case ServiceEntityAssociationNameEditPart.VISUAL_ID:
				return new ServiceEntityAssociationNameEditPart(view);

			case ServiceViewAssociationEditPart.VISUAL_ID:
				return new ServiceViewAssociationEditPart(view);
			...
			case ActionUnitUnitFieldCompartmentEditPart.VISUAL_ID:
				return new ActionUnitUnitFieldCompartmentEditPart(view);

			case ActionUnitActionCompartmentEditPart.VISUAL_ID:
				return new ActionUnitActionCompartmentEditPart(view);

			case CommandUnitCommandsCompartmentEditPart.VISUAL_ID:
				return new CommandUnitCommandsCompartmentEditPart(view);
			...
			case UnitAssociationActionCompartment3EditPart.VISUAL_ID:
				return new UnitAssociationActionCompartment3EditPart(view);
