...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DataTypeField2ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class DataTypeField2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DataTypeField2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DataTypeField2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DataTypeFieldName2EditPart) {
			((DataTypeFieldName2EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DataTypeFieldName2EditPart.VISUAL_ID));
	}
