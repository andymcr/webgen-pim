...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DeleteAction4ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class DeleteAction4EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public DeleteAction4EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DeleteAction4ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DeleteActionName4EditPart) {
			((DeleteActionName4EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActionNameLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DeleteActionName4EditPart.VISUAL_ID));
	}
