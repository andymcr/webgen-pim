...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DataTypeField4ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class DataTypeField4EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DataTypeField4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DataTypeField4ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DataTypeFieldName4EditPart) {
			((DataTypeFieldName4EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DataTypeFieldName4EditPart.VISUAL_ID));
	}
