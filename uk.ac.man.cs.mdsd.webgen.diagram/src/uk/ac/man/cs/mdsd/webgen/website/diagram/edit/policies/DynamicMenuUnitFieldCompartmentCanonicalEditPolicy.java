 ...
 * @generated
 */
public class DynamicMenuUnitFieldCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getDynamicMenuServiceFeaturesCompartment_7081SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return MenuIncludedElementEditPart.VISUAL_ID == WebsiteVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getDynamicMenuServiceFeaturesCompartment_7081SemanticChildren((View) getHost()
						.getModel());
