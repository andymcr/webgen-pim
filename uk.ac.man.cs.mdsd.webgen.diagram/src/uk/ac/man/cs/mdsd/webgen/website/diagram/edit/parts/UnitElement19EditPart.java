...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitElement19ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class UnitElement19EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public UnitElement19EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new UnitElement19ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitElementName19EditPart) {
			((UnitElementName19EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitElementName19EditPart.VISUAL_ID));
	}
