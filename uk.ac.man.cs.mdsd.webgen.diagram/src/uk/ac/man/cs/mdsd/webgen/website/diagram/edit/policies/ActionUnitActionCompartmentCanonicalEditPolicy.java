 ...
 * @generated
 */
public class ActionUnitActionCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return UnitSupportActionEditPart.VISUAL_ID == WebsiteVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getActionUnitActionCompartment_7104SemanticChildren((View) getHost()
						.getModel());
