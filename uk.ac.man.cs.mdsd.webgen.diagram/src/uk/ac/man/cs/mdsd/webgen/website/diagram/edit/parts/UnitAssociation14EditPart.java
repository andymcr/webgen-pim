...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitAssociation14ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class UnitAssociation14EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public UnitAssociation14EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new UnitAssociation14ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitAssociationName14EditPart) {
			((UnitAssociationName14EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitAssociationName14EditPart.VISUAL_ID));
	}
