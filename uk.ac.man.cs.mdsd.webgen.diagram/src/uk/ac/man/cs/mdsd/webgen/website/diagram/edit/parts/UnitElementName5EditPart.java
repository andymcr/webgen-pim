 ...
 * @generated
 */
public class UnitElementName5EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitElementName5EditPart.VISUAL_ID));
		}
		return parser;
	}
