 ...
 * @generated
 */
public class EncapsulatedAssociationItemSemanticEditPolicy extends WebsiteBaseItemSemanticEditPolicy {
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (WebsiteVisualIDRegistry.getVisualID(incomingLink) == ViewAssociationEditPart.VISUAL_ID) {
