...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UrlAttributeItemSemanticEditPolicy;
...
public class UrlAttributeEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UrlAttributeNameEditPart) {
			((UrlAttributeNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAttributeNameLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UrlAttributeNameEditPart.VISUAL_ID));
	}
