 ...
 * @generated
 */
public class UnitAssociationName12EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public UnitAssociationName12EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WebsiteParserProvider.getParser(WebsiteElementTypes.UnitAssociation_3194, getParserElement(),
					WebsiteVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitAssociationName12EditPart.VISUAL_ID));
		}
		return parser;
	}
