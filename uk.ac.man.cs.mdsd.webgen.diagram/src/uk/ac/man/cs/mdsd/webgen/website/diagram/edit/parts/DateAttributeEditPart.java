...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DateAttributeItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class DateAttributeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DateAttributeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DateAttributeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DateAttributeNameEditPart) {
			((DateAttributeNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAttributeNameLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DateAttributeNameEditPart.VISUAL_ID));
	}
