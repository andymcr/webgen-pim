...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DataTypeField3ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class DataTypeField3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DataTypeField3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DataTypeField3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DataTypeFieldName3EditPart) {
			((DataTypeFieldName3EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DataTypeFieldName3EditPart.VISUAL_ID));
	}
