 ...
 * @generated
 */
public class IndexUnitUnitFieldCompartment7CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == UnitElement17EditPart.VISUAL_ID
				|| visualID == UnitAssociation15EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getIndexUnitUnitFieldCompartment_7076SemanticChildren((View) getHost()
						.getModel());
