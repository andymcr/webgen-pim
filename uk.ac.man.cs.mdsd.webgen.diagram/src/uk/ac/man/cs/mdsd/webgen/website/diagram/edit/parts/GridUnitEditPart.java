...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.GridUnitItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class GridUnitEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public GridUnitEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new GridUnitItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GridUnitNameEditPart) {
			((GridUnitNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureInterfaceUnitNameLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(GridUnitNameEditPart.VISUAL_ID));
	}
