...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DataTypeAttributeItemSemanticEditPolicy;
...
public class DataTypeAttributeEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DataTypeAttributeNameEditPart) {
			((DataTypeAttributeNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DataTypeAttributeNameEditPart.VISUAL_ID));
	}
