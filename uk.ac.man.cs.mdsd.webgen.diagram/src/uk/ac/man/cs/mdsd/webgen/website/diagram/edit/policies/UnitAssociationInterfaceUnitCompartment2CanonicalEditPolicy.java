 ...
 * @generated
 */
public class UnitAssociationInterfaceUnitCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == DetailsUnit3EditPart.VISUAL_ID
				|| visualID == IndexUnitEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getUnitAssociationInterfaceUnitsCompartment_7097SemanticChildren((View) getHost()
						.getModel());
