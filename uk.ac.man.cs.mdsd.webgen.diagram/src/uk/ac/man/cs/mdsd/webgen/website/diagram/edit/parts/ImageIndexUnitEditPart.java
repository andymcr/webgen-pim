...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.ImageIndexUnitItemSemanticEditPolicy;
...
public class ImageIndexUnitEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ImageIndexUnitNameEditPart) {
			((ImageIndexUnitNameEditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(ImageIndexUnitNameEditPart.VISUAL_ID));
	}
