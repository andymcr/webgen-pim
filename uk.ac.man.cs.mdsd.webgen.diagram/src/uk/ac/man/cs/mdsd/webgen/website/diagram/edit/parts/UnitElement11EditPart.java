...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitElement11ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class UnitElement11EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public UnitElement11EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new UnitElement11ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitElementName11EditPart) {
			((UnitElementName11EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitElementName11EditPart.VISUAL_ID));
	}
