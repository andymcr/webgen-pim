...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitAssociation8ItemSemanticEditPolicy;
...
public class UnitAssociation8EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitAssociationName8EditPart) {
			((UnitAssociationName8EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitAssociationName8EditPart.VISUAL_ID));
	}
