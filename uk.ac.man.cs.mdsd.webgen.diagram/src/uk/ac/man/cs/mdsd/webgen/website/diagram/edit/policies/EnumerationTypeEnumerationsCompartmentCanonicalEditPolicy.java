 ...
 * @generated
 */
public class EnumerationTypeEnumerationsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return EnumerationLiteralEditPart.VISUAL_ID == WebsiteVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getEnumerationTypeEnumerationsCompartment_7016SemanticChildren((View) getHost()
						.getModel());
