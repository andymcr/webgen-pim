...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DeleteActionItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class DeleteActionEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DeleteActionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DeleteActionItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DeleteActionNameEditPart) {
			((DeleteActionNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureActionNameLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DeleteActionNameEditPart.VISUAL_ID));
	}
