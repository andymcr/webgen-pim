...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitAssociation17ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class UnitAssociation17EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public UnitAssociation17EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new UnitAssociation17ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitAssociationName17EditPart) {
			((UnitAssociationName17EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitAssociationName17EditPart.VISUAL_ID));
	}
