 ...
 * @generated
 */
public class FeatureSupportActionNameEditPart extends CompartmentEditPart
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.FeatureSupportActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
