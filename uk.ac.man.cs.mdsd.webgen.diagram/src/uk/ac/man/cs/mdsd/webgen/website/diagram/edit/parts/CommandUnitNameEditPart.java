 ...
 * @generated
 */
public class CommandUnitNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CommandUnitNameEditPart(View view) {
		super(view);
	}
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.CommandUnitNameEditPart.VISUAL_ID));
		}
		return parser;
	}
