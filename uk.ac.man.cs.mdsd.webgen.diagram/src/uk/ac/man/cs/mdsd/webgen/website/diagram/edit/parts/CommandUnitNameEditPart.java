 ...
 * @generated
 */
public class CommandUnitNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WebsiteParserProvider.getParser(WebsiteElementTypes.CommandUnit_3225, getParserElement(),
					WebsiteVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.CommandUnitNameEditPart.VISUAL_ID));
		}
		return parser;
	}
