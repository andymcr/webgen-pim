...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitAssociation6ItemSemanticEditPolicy;
...
public class UnitAssociation6EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitAssociationName6EditPart) {
			((UnitAssociationName6EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitAssociationName6EditPart.VISUAL_ID));
	}
