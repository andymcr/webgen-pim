 ...
 * @generated
 */
public class DetailsUnitUnitFieldCompartment6CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == UnitElement13EditPart.VISUAL_ID
				|| visualID == UnitAssociation11EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getDetailsUnitUnitFieldCompartment_7068SemanticChildren((View) getHost()
						.getModel());
