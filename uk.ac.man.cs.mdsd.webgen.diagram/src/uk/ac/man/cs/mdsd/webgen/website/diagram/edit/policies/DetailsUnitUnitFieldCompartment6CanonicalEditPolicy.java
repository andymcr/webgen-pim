...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitAssociation11EditPart;
 ...
 * @generated
 */
public class DetailsUnitUnitFieldCompartment6CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getDetailsUnitUnitFieldCompartment_7068SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == UnitElement13EditPart.VISUAL_ID || visualID == UnitAssociation11EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getDetailsUnitUnitFieldCompartment_7068SemanticChildren((View) getHost().getModel());
