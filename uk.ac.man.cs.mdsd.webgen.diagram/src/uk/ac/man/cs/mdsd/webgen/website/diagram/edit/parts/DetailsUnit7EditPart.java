...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DetailsUnit7ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DetailsUnit7EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DetailsUnit7EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DetailsUnit7ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DetailsUnitName7EditPart) {
			((DetailsUnitName7EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DetailsUnitName7EditPart.VISUAL_ID));
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == WebsiteElementTypes.UnitElement_3346) {
				return getChildBySemanticHint(
						WebsiteVisualIDRegistry.getType(DetailsUnitUnitFieldCompartment7EditPart.VISUAL_ID));
			}
			if (type == WebsiteElementTypes.UnitAssociation_3347) {
				return getChildBySemanticHint(
						WebsiteVisualIDRegistry.getType(DetailsUnitUnitFieldCompartment7EditPart.VISUAL_ID));
			}
		}
