...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.IndexUnit5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IndexUnit5EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public IndexUnit5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new IndexUnit5ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof IndexUnitName5EditPart) {
			((IndexUnitName5EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(IndexUnitName5EditPart.VISUAL_ID));
	}
