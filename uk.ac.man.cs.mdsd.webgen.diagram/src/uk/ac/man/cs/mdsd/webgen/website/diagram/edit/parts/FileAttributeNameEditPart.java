 ...
 * @generated
 */
public class FileAttributeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.FileAttributeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
