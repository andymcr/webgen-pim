 ...
 * @generated
 */
public class UserCommandNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WebsiteParserProvider.getParser(WebsiteElementTypes.UserCommand_3226, getParserElement(),
					WebsiteVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UserCommandNameEditPart.VISUAL_ID));
		}
		return parser;
	}
