...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitElement8ItemSemanticEditPolicy;
...
public class UnitElement8EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitElementName8EditPart) {
			((UnitElementName8EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitElementName8EditPart.VISUAL_ID));
	}
