...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.SliderUnitItemSemanticEditPolicy;
...
public class SliderUnitEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SliderUnitNameEditPart) {
			((SliderUnitNameEditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(SliderUnitNameEditPart.VISUAL_ID));
	}
