 ...
 * @generated
 */
public class ModelLabelNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.ModelLabelNameEditPart.VISUAL_ID));
		}
		return parser;
	}
