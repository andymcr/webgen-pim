...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitAssociation2ItemSemanticEditPolicy;
...
public class UnitAssociation2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitAssociationName2EditPart) {
			((UnitAssociationName2EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitAssociationName2EditPart.VISUAL_ID));
	}
