...
public class WebsiteViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return WebsitePropertiesEditPart.VISUAL_ID == visualID
				...
				|| ImageAttributeEditPart.VISUAL_ID == visualID
				...
				|| FeatureSupportActionEditPart.VISUAL_ID == visualID
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case FileAttributeEditPart.VISUAL_ID:
			return createFileAttribute_3152(domainElement, containerView,
					index, persisted, preferencesHint);
		case ImageAttributeEditPart.VISUAL_ID:
			return createImageAttribute_3235(domainElement, containerView,
					index, persisted, preferencesHint);
		case LocationAttributeEditPart.VISUAL_ID:
		...
		case DeleteAction2EditPart.VISUAL_ID:
			return createDeleteAction_3147(domainElement, containerView, index,
					persisted, preferencesHint);
		case FeatureSupportActionEditPart.VISUAL_ID:
			return createFeatureSupportAction_3234(domainElement,
					containerView, index, persisted, preferencesHint);
		case MapUnitEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	public Node createImageAttribute_3235(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		Node label5242 = createLabel(node,
				WebsiteVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createFeatureSupportAction_3234(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(WebsiteVisualIDRegistry
				.getType(FeatureSupportActionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label5241 = createLabel(node,
				WebsiteVisualIDRegistry
