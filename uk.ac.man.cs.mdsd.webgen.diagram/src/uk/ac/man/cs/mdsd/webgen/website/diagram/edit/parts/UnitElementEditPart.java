...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitElementItemSemanticEditPolicy;
...
public class UnitElementEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitElementNameEditPart) {
			((UnitElementNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitElementNameEditPart.VISUAL_ID));
	}
