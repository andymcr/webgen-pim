 ...
 * @generated
 */
public class SelectActionName7EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WebsiteParserProvider.getParser(WebsiteElementTypes.SelectAction_3354, getParserElement(),
					WebsiteVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.SelectActionName7EditPart.VISUAL_ID));
		}
		return parser;
	}
