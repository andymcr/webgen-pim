 ...
 * @generated
 */
public class UnitAssociationNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitAssociationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
