...
public class CreateUpdateUnitUnitFieldCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getCreateUpdateUnitUnitFieldCompartment_7150SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getCreateUpdateUnitUnitFieldCompartment_7150SemanticChildren((View) getHost().getModel());
