 ...
 * @generated
 */
public class CreateUpdateUnitUnitFieldCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getCreateUpdateUnitUnitFieldCompartment_7130SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return UnitElement3EditPart.VISUAL_ID == WebsiteVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getCreateUpdateUnitUnitFieldCompartment_7130SemanticChildren((View) getHost().getModel());
