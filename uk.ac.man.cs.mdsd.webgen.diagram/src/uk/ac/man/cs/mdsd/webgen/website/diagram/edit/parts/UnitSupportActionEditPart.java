...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitSupportActionItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class UnitSupportActionEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public UnitSupportActionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new UnitSupportActionItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitSupportActionNameEditPart) {
			((UnitSupportActionNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitSupportActionNameEditPart.VISUAL_ID));
	}
