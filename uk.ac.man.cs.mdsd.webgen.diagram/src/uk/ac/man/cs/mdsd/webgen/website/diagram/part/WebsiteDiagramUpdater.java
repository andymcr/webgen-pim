...
public class WebsiteDiagramUpdater {
	...
	public static List<WebsiteNodeDescriptor> getSemanticChildren(View view) {
		...
		case ActionUnitUnitFieldCompartmentEditPart.VISUAL_ID:
			return getActionUnitUnitFieldCompartment_7103SemanticChildren(view);
		case ActionUnitActionCompartmentEditPart.VISUAL_ID:
			return getActionUnitActionCompartment_7104SemanticChildren(view);
		case CommandUnitCommandsCompartmentEditPart.VISUAL_ID:
			return getCommandUnitCommandsCompartment_7117SemanticChildren(view);
		...
		case UnitElementActionCompartmentEditPart.VISUAL_ID:
			return getUnitElementActionCompartment_7105SemanticChildren(view);
		...
		case UnitAssociationActionCompartmentEditPart.VISUAL_ID:
			return getUnitAssociationActionCompartment_7106SemanticChildren(view);
		...
		case UnitAssociationInterfaceUnitCompartment4EditPart.VISUAL_ID:
			return getUnitAssociationInterfaceUnitsCompartment_7107SemanticChildren(view);
		...
		case UnitAssociationInterfaceUnitCompartment5EditPart.VISUAL_ID:
			return getUnitAssociationInterfaceUnitsCompartment_7108SemanticChildren(view);
		...
		case UnitElementActionCompartment2EditPart.VISUAL_ID:
			return getUnitElementActionCompartment_7109SemanticChildren(view);
		case UnitAssociationActionCompartment2EditPart.VISUAL_ID:
			return getUnitAssociationInterfaceUnitsCompartment_7110SemanticChildren(view);
		case UnitAssociationActionCompartment3EditPart.VISUAL_ID:
			return getUnitAssociationActionCompartment_7112SemanticChildren(view);
		...
		case UnitAssociationInterfaceUnitsCompartmentEditPart.VISUAL_ID:
			return getUnitAssociationInterfaceUnitsCompartment_7114SemanticChildren(view);
	...
	*/
	public static List<WebsiteNodeDescriptor> getEntityModelLabelsCompartment_7118SemanticChildren(View view) {
		...
		for (Iterator<?> it = modelElement.getDisplayLabels().iterator(); it.hasNext();) {
			ModelLabelY childElement = (ModelLabelY) it.next();
			int visualID = WebsiteVisualIDRegistry.getNodeVisualID(view, childElement);
			if (visualID == ModelLabelYEditPart.VISUAL_ID) {
				result.add(new WebsiteNodeDescriptor(childElement, visualID));
				continue;
			}
		}
	...
	*/
	public static List<WebsiteNodeDescriptor> getViewAttributeCompartment_7119SemanticChildren(View view) {
		...
		for (Iterator<?> it = modelElement.getFeatures().iterator(); it.hasNext();) {
			...
			int visualID = WebsiteVisualIDRegistry.getNodeVisualID(view, childElement);
			if (visualID == ViewAttributeEditPart.VISUAL_ID) {
				result.add(new WebsiteNodeDescriptor(childElement, visualID));
				continue;
			}
	...
	*/
	public static List<WebsiteNodeDescriptor> getViewModelLabelsCompartment_7120SemanticChildren(View view) {
		...
		for (Iterator<?> it = modelElement.getDisplayLabels().iterator(); it.hasNext();) {
			ModelLabelY childElement = (ModelLabelY) it.next();
			int visualID = WebsiteVisualIDRegistry.getNodeVisualID(view, childElement);
			if (visualID == ModelLabelY2EditPart.VISUAL_ID) {
				result.add(new WebsiteNodeDescriptor(childElement, visualID));
				continue;
			}
		}
	...
	public static List<WebsiteNodeDescriptor> getPageInterfaceUnitsCompartment_7002SemanticChildren(View view) {
		...
		for (Iterator<?> it = modelElement.getUnits().iterator(); it.hasNext();) {
			...
			if (visualID == CommandUnitEditPart.VISUAL_ID) {
				result.add(new WebsiteNodeDescriptor(childElement, visualID));
				continue;
			}
	 ...
	 * @generated
	 */
	public static List<WebsiteNodeDescriptor> getUnitAssociationInterfaceUnitsCompartment_7107SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.emptyList();
		}
	 ...
	 * @generated
	 */
	public static List<WebsiteNodeDescriptor> getUnitAssociationInterfaceUnitsCompartment_7108SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.emptyList();
		}
	 ...
	 * @generated
	 */
	public static List<WebsiteNodeDescriptor> getUnitAssociationInterfaceUnitsCompartment_7110SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.emptyList();
		}
	...
	public static List<WebsiteNodeDescriptor> getUpdateUnitUnitFieldCompartment_7049SemanticChildren(View view) {
		...
		for (Iterator<?> it = modelElement.getDisplayFields().iterator(); it.hasNext();) {
			...
			if (visualID == DataTypeField7EditPart.VISUAL_ID) {
				result.add(new WebsiteNodeDescriptor(childElement, visualID));
				continue;
			}
			if (visualID == DateField7EditPart.VISUAL_ID) {
				result.add(new WebsiteNodeDescriptor(childElement, visualID));
				continue;
			}
		}
	 ...
	 * @generated
	 */
	public static List<WebsiteNodeDescriptor> getUnitAssociationInterfaceUnitsCompartment_7114SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.emptyList();
		}
	...
	public static List<WebsiteNodeDescriptor> getIndexUnitUnitFieldCompartment_7115SemanticChildren(View view) {
		...
		for (Iterator<?> it = modelElement.getDisplayFields().iterator(); it.hasNext();) {
			...
			if (visualID == UnitAssociation18EditPart.VISUAL_ID) {
				result.add(new WebsiteNodeDescriptor(childElement, visualID));
				continue;
			}
		}
	...
	public static List<WebsiteNodeDescriptor> getStaticMenuMenuEntriesCompartment_7084SemanticChildren(View view) {
		...
		for (Iterator<?> it = modelElement.getEntries().iterator(); it.hasNext();) {
			...
			if (visualID == FixedCommandMenuEntryEditPart.VISUAL_ID) {
				result.add(new WebsiteNodeDescriptor(childElement, visualID));
				continue;
			}
	...
	public static List<WebsiteNodeDescriptor> getServiceServiceFeaturesCompartment_7006SemanticChildren(View view) {
		...
		for (Iterator<?> it = modelElement.getFeatures().iterator(); it.hasNext();) {
			...
			if (visualID == ServiceEntityAssociationEditPart.VISUAL_ID) {
				result.add(new WebsiteNodeDescriptor(childElement, visualID));
				continue;
			}
			if (visualID == ServiceViewAssociationEditPart.VISUAL_ID) {
				result.add(new WebsiteNodeDescriptor(childElement, visualID));
				continue;
			}
		}
	...
	*/
	...
	public static List<WebsiteLinkDescriptor> getContainedLinks(View view) {
		...
		case ImageAttributeEditPart.VISUAL_ID:
			return getImageAttribute_3235ContainedLinks(view);
		case LocationAttributeEditPart.VISUAL_ID:
			return getLocationAttribute_3230ContainedLinks(view);
		case ModelLabelYEditPart.VISUAL_ID:
			return getModelLabelY_3237ContainedLinks(view);
		case ModelLabelY2EditPart.VISUAL_ID:
			return getModelLabelY_3238ContainedLinks(view);
		case ViewAttributeEditPart.VISUAL_ID:
			return getViewAttribute_3239ContainedLinks(view);
		case ViewAssociationEditPart.VISUAL_ID:
			return getViewAssociation_3240ContainedLinks(view);
		case ActionUnitEditPart.VISUAL_ID:
			return getActionUnit_3213ContainedLinks(view);
		...
		case CommandUnitEditPart.VISUAL_ID:
			return getCommandUnit_3225ContainedLinks(view);
		case UserCommandEditPart.VISUAL_ID:
			return getUserCommand_3226ContainedLinks(view);
		...
		case UnitSupportAction2EditPart.VISUAL_ID:
			return getUnitSupportAction_3233ContainedLinks(view);
		...
		case UnitElement20EditPart.VISUAL_ID:
			return getUnitElement_3223ContainedLinks(view);
		case UnitAssociation18EditPart.VISUAL_ID:
			return getUnitAssociation_3224ContainedLinks(view);
		...
		case ServiceEntityElementEditPart.VISUAL_ID:
			return getServiceEntityElement_3167ContainedLinks(view);
		case ServiceEntityAssociationEditPart.VISUAL_ID:
			return getServiceEntityAssociation_3168ContainedLinks(view);
		case ServiceViewAssociationEditPart.VISUAL_ID:
			return getServiceViewAssociation_3166ContainedLinks(view);
	...
	public static List<WebsiteLinkDescriptor> getIncomingLinks(View view) {
		...
		case ImageAttributeEditPart.VISUAL_ID:
			return getImageAttribute_3235IncomingLinks(view);
		case LocationAttributeEditPart.VISUAL_ID:
			return getLocationAttribute_3230IncomingLinks(view);
		case ModelLabelYEditPart.VISUAL_ID:
			return getModelLabelY_3237IncomingLinks(view);
		case ModelLabelY2EditPart.VISUAL_ID:
			return getModelLabelY_3238IncomingLinks(view);
		case ViewAttributeEditPart.VISUAL_ID:
			return getViewAttribute_3239IncomingLinks(view);
		case ViewAssociationEditPart.VISUAL_ID:
			return getViewAssociation_3240IncomingLinks(view);
		case ActionUnitEditPart.VISUAL_ID:
			return getActionUnit_3213IncomingLinks(view);
		case UnitElementEditPart.VISUAL_ID:
		...
		case CommandUnitEditPart.VISUAL_ID:
			return getCommandUnit_3225IncomingLinks(view);
		case UserCommandEditPart.VISUAL_ID:
			return getUserCommand_3226IncomingLinks(view);
		case CreateUnitEditPart.VISUAL_ID:
		...
		case UnitSupportAction2EditPart.VISUAL_ID:
			return getUnitSupportAction_3233IncomingLinks(view);
		case IndexUnit6EditPart.VISUAL_ID:
		...
		case UnitElement20EditPart.VISUAL_ID:
			return getUnitElement_3223IncomingLinks(view);
		case UnitAssociation18EditPart.VISUAL_ID:
			return getUnitAssociation_3224IncomingLinks(view);
		case SelectAction7EditPart.VISUAL_ID:
		...
		case ServiceEntityElementEditPart.VISUAL_ID:
			return getServiceEntityElement_3167IncomingLinks(view);
		case ServiceEntityAssociationEditPart.VISUAL_ID:
			return getServiceEntityAssociation_3168IncomingLinks(view);
		case ServiceViewAssociationEditPart.VISUAL_ID:
			return getServiceViewAssociation_3166IncomingLinks(view);
		case SelectionEditPart.VISUAL_ID:
	...
	public static List<WebsiteLinkDescriptor> getOutgoingLinks(View view) {
		...
		case ImageAttributeEditPart.VISUAL_ID:
			return getImageAttribute_3235OutgoingLinks(view);
		case LocationAttributeEditPart.VISUAL_ID:
			return getLocationAttribute_3230OutgoingLinks(view);
		case ModelLabelYEditPart.VISUAL_ID:
			return getModelLabelY_3237OutgoingLinks(view);
		case ModelLabelY2EditPart.VISUAL_ID:
			return getModelLabelY_3238OutgoingLinks(view);
		case ViewAttributeEditPart.VISUAL_ID:
			return getViewAttribute_3239OutgoingLinks(view);
		case ViewAssociationEditPart.VISUAL_ID:
			return getViewAssociation_3240OutgoingLinks(view);
		case ActionUnitEditPart.VISUAL_ID:
			return getActionUnit_3213OutgoingLinks(view);
		case UnitElementEditPart.VISUAL_ID:
		...
		case CommandUnitEditPart.VISUAL_ID:
			return getCommandUnit_3225OutgoingLinks(view);
		case UserCommandEditPart.VISUAL_ID:
			return getUserCommand_3226OutgoingLinks(view);
		case CreateUnitEditPart.VISUAL_ID:
		...
		case UnitSupportAction2EditPart.VISUAL_ID:
			return getUnitSupportAction_3233OutgoingLinks(view);
		case IndexUnit6EditPart.VISUAL_ID:
		...
		case UnitElement20EditPart.VISUAL_ID:
			return getUnitElement_3223OutgoingLinks(view);
		case UnitAssociation18EditPart.VISUAL_ID:
			return getUnitAssociation_3224OutgoingLinks(view);
		case SelectAction7EditPart.VISUAL_ID:
		...
		case ServiceEntityElementEditPart.VISUAL_ID:
			return getServiceEntityElement_3167OutgoingLinks(view);
		case ServiceEntityAssociationEditPart.VISUAL_ID:
			return getServiceEntityAssociation_3168OutgoingLinks(view);
		case ServiceViewAssociationEditPart.VISUAL_ID:
			return getServiceViewAssociation_3166OutgoingLinks(view);
		case SelectionEditPart.VISUAL_ID:
	...
	* @generated
	*/
	public static List<WebsiteLinkDescriptor> getModelLabelY_3237ContainedLinks(View view) {
		return Collections.emptyList();
	}
	...
	* @generated
	*/
	public static List<WebsiteLinkDescriptor> getModelLabelY_3238ContainedLinks(View view) {
		return Collections.emptyList();
	}
	...
	* @generated
	*/
	public static List<WebsiteLinkDescriptor> getViewAttribute_3239ContainedLinks(View view) {
		return Collections.emptyList();
	}
	...
	* @generated
	*/
	public static List<WebsiteLinkDescriptor> getViewAssociation_3240ContainedLinks(View view) {
		return Collections.emptyList();
	}
	...
	* @generated
	*/
	public static List<WebsiteLinkDescriptor> getModelLabelY_3237IncomingLinks(View view) {
		return Collections.emptyList();
	}
	...
	* @generated
	*/
	public static List<WebsiteLinkDescriptor> getModelLabelY_3238IncomingLinks(View view) {
		return Collections.emptyList();
	}
	...
	* @generated
	*/
	public static List<WebsiteLinkDescriptor> getViewAttribute_3239IncomingLinks(View view) {
		return Collections.emptyList();
	}
	...
	* @generated
	*/
	public static List<WebsiteLinkDescriptor> getViewAssociation_3240IncomingLinks(View view) {
		return Collections.emptyList();
	}
	...
	* @generated
	*/
	public static List<WebsiteLinkDescriptor> getModelLabelY_3237OutgoingLinks(View view) {
		return Collections.emptyList();
	}
	...
	* @generated
	*/
	public static List<WebsiteLinkDescriptor> getModelLabelY_3238OutgoingLinks(View view) {
		return Collections.emptyList();
	}
	...
	* @generated
	*/
	public static List<WebsiteLinkDescriptor> getViewAttribute_3239OutgoingLinks(View view) {
		return Collections.emptyList();
	}
	...
	* @generated
	*/
	public static List<WebsiteLinkDescriptor> getViewAssociation_3240OutgoingLinks(View view) {
		return Collections.emptyList();
	}
