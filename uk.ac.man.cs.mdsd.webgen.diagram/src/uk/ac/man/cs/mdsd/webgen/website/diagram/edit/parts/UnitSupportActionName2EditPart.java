 ...
 * @generated
 */
public class UnitSupportActionName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public UnitSupportActionName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WebsiteParserProvider.getParser(WebsiteElementTypes.UnitSupportAction_3233, getParserElement(),
					WebsiteVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitSupportActionName2EditPart.VISUAL_ID));
		}
		return parser;
	}
