...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitElement9ItemSemanticEditPolicy;
...
public class UnitElement9EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitElementName9EditPart) {
			((UnitElementName9EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitElementName9EditPart.VISUAL_ID));
	}
