...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DeleteAction3ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class DeleteAction3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DeleteAction3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DeleteAction3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DeleteActionName3EditPart) {
			((DeleteActionName3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActionNameLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DeleteActionName3EditPart.VISUAL_ID));
	}
