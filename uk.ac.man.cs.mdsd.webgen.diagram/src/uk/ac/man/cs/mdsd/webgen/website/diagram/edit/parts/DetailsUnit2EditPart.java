...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.DetailsUnit2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DetailsUnit2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DetailsUnit2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DetailsUnit2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DetailsUnitName2EditPart) {
			((DetailsUnitName2EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(DetailsUnitName2EditPart.VISUAL_ID));
	}
