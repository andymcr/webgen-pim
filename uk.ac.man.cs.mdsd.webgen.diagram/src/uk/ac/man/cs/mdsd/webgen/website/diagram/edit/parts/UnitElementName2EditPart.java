 ...
 * @generated
 */
public class UnitElementName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitElementName2EditPart.VISUAL_ID));
		}
		return parser;
	}
