...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitElement7ItemSemanticEditPolicy;
...
public class UnitElement7EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitElementName7EditPart) {
			((UnitElementName7EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitElementName7EditPart.VISUAL_ID));
	}
