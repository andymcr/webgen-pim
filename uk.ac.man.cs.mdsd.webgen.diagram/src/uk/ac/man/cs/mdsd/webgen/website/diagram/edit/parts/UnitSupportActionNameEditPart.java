 ...
 * @generated
 */
public class UnitSupportActionNameEditPart extends CompartmentEditPart
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitSupportActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
