...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitElement20ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class UnitElement20EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public UnitElement20EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new UnitElement20ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitElementName20EditPart) {
			((UnitElementName20EditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitElementName20EditPart.VISUAL_ID));
	}
