...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitAssociation3ItemSemanticEditPolicy;
...
public class UnitAssociation3EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitAssociationName3EditPart) {
			((UnitAssociationName3EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitAssociationName3EditPart.VISUAL_ID));
	}
