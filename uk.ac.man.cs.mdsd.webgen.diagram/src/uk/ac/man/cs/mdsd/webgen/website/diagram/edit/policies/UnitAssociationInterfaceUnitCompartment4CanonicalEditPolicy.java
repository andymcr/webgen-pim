 ...
 * @generated
 */
public class UnitAssociationInterfaceUnitCompartment4CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == DetailsUnit5EditPart.VISUAL_ID
				|| visualID == IndexUnit3EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getUnitAssociationInterfaceUnitsCompartment_7107SemanticChildren((View) getHost()
						.getModel());
