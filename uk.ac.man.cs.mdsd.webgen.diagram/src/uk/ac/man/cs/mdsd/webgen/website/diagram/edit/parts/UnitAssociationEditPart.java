...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitAssociationItemSemanticEditPolicy;
...
public class UnitAssociationEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitAssociationNameEditPart) {
			((UnitAssociationNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitAssociationNameEditPart.VISUAL_ID));
	}
