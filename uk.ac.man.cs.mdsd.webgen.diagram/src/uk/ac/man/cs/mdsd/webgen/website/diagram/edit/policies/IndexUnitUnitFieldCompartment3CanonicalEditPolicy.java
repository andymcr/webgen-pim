 ...
 * @generated
 */
public class IndexUnitUnitFieldCompartment3CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == UnitElement11EditPart.VISUAL_ID
				|| visualID == UnitAssociation9EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getIndexUnitUnitFieldCompartment_7057SemanticChildren((View) getHost()
						.getModel());
