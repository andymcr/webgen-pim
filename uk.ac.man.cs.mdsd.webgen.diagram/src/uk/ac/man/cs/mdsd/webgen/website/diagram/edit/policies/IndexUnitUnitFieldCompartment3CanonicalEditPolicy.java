...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitAssociation8EditPart;
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitElement11EditPart;
 ...
 * @generated
 */
public class IndexUnitUnitFieldCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getIndexUnitUnitFieldCompartment_7057SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == UnitElement11EditPart.VISUAL_ID || visualID == UnitAssociation8EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getIndexUnitUnitFieldCompartment_7057SemanticChildren((View) getHost().getModel());
