 ...
 * @generated
 */
public class ActionMenuEntryNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ActionMenuEntryNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WebsiteParserProvider.getParser(WebsiteElementTypes.ActionMenuEntry_3236, getParserElement(),
					WebsiteVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.ActionMenuEntryNameEditPart.VISUAL_ID));
		}
		return parser;
	}
