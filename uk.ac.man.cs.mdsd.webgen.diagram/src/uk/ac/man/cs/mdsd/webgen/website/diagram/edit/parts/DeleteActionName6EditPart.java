 ...
 * @generated
 */
public class DeleteActionName6EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DeleteActionName6EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WebsiteParserProvider.getParser(WebsiteElementTypes.DeleteAction_3273, getParserElement(),
					WebsiteVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.DeleteActionName6EditPart.VISUAL_ID));
		}
		return parser;
	}
