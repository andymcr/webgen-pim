 ...
 * @generated
 */
public class DetailsUnitUnitFieldCompartment7CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == UnitElement16EditPart.VISUAL_ID
				|| visualID == UnitAssociation14EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getDetailsUnitUnitFieldCompartment_7113SemanticChildren((View) getHost()
						.getModel());
