...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitElement6ItemSemanticEditPolicy;
...
public class UnitElement6EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitElementName6EditPart) {
			((UnitElementName6EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitElementName6EditPart.VISUAL_ID));
	}
