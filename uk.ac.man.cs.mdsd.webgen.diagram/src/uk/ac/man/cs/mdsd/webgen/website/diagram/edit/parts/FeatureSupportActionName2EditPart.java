 ...
 * @generated
 */
public class FeatureSupportActionName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FeatureSupportActionName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = WebsiteParserProvider.getParser(WebsiteElementTypes.FeatureSupportAction_3266, getParserElement(),
					WebsiteVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.FeatureSupportActionName2EditPart.VISUAL_ID));
		}
		return parser;
	}
