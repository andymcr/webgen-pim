...
public class CreateUpdateUnitUnitFieldCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getCreateUpdateUnitUnitFieldCompartment_7148SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getCreateUpdateUnitUnitFieldCompartment_7148SemanticChildren((View) getHost().getModel());
