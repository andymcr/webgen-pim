 ...
 * @generated
 */
public class ServiceEntityElementNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WebsiteParserProvider.getParser(WebsiteElementTypes.ServiceEntityElement_3167, getParserElement(),
					WebsiteVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.ServiceEntityElementNameEditPart.VISUAL_ID));
		}
		return parser;
	}
