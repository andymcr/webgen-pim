 ...
 * @generated
 */
public class UnitElementName9EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = WebsiteParserProvider
					.getParser(
							...
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitElementName9EditPart.VISUAL_ID));
		}
		return parser;
	}
