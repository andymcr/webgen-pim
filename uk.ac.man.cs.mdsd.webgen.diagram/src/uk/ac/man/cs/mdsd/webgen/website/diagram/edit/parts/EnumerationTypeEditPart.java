...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.EnumerationTypeItemSemanticEditPolicy;
...
public class EnumerationTypeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new EnumerationTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EnumerationTypeNameEditPart) {
			((EnumerationTypeNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureEnumerationTypeNameLabelFigure());
			return true;
		}
		return false;
	}
	...
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(90, 40);
		return result;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(EnumerationTypeNameEditPart.VISUAL_ID));
	}
	...
	public class EnumerationTypeFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureEnumerationTypeNameLabelFigure;
		...
		private void createContents() {
			...
			fFigureEnumerationTypeNameLabelFigure = new WrappingLabel();

			fFigureEnumerationTypeNameLabelFigure.setText("");

			this.add(fFigureEnumerationTypeNameLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureEnumerationTypeNameLabelFigure() {
			return fFigureEnumerationTypeNameLabelFigure;
		}
	 ...
	 * @generated
	 */
	static final Color THIS_FORE = new Color(null, 222, 184, 135);

	/**
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 245, 222, 179);
