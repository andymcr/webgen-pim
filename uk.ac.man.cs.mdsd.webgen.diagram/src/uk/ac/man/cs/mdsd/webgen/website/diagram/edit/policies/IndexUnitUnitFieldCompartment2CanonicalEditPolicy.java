 ...
 * @generated
 */
public class IndexUnitUnitFieldCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == UnitElement8EditPart.VISUAL_ID
				|| visualID == UnitAssociation6EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getIndexUnitUnitFieldCompartment_7054SemanticChildren((View) getHost()
						.getModel());
