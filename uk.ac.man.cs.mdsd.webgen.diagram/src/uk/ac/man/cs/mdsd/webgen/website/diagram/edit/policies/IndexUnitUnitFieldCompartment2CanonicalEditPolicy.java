...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitElement7EditPart;
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.UnitElement8EditPart;
 ...
 * @generated
 */
public class IndexUnitUnitFieldCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getIndexUnitUnitFieldCompartment_7054SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == UnitElement8EditPart.VISUAL_ID || visualID == UnitAssociation5EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<WebsiteNodeDescriptor> childDescriptors = WebsiteDiagramUpdater
				.getIndexUnitUnitFieldCompartment_7054SemanticChildren((View) getHost().getModel());
