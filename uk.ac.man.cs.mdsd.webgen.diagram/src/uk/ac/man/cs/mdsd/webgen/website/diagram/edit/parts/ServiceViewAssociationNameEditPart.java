 ...
 * @generated
 */
public class ServiceViewAssociationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WebsiteParserProvider.getParser(WebsiteElementTypes.ServiceViewAssociation_3166,
					getParserElement(), WebsiteVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.ServiceViewAssociationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
