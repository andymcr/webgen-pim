 ...
 * @generated
 */
public class ServiceViewAssociationNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ServiceViewAssociationNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new WebsiteTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WebsiteParserProvider
					.getParser(
							WebsiteElementTypes.ServiceViewAssociation_3166,
							getParserElement(),
							WebsiteVisualIDRegistry
									.getType(uk.ac.man.cs.mdsd.webgen.website.diagram.edit.parts.ServiceViewAssociationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					WebsiteEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
