...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitElement2ItemSemanticEditPolicy;
...
public class UnitElement2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitElementName2EditPart) {
			((UnitElementName2EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitElementName2EditPart.VISUAL_ID));
	}
