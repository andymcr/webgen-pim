...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitAssociation18ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.website.diagram.part.WebsiteVisualIDRegistry;

/**
 * @generated
 */
public class UnitAssociation18EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public UnitAssociation18EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new UnitAssociation18ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitAssociationName18EditPart) {
			((UnitAssociationName18EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitAssociationName18EditPart.VISUAL_ID));
	}
