...
import uk.ac.man.cs.mdsd.webgen.website.diagram.edit.policies.UnitElement3ItemSemanticEditPolicy;
...
public class UnitElement3EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UnitElementName3EditPart) {
			((UnitElementName3EditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WebsiteVisualIDRegistry.getType(UnitElementName3EditPart.VISUAL_ID));
	}
