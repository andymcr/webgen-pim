 ...
 * @generated
 */
public class DateAttributeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DateAttributeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PersistenceParserProvider.getParser(PersistenceElementTypes.DateAttribute_3002, getParserElement(),
					PersistenceVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.persistence.diagram.edit.parts.DateAttributeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
