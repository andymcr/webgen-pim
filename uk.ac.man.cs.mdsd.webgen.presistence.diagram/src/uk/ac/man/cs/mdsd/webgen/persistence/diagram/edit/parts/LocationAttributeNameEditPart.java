 ...
 * @generated
 */
public class LocationAttributeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LocationAttributeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PersistenceParserProvider.getParser(PersistenceElementTypes.LocationAttribute_3006,
					getParserElement(), PersistenceVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.persistence.diagram.edit.parts.LocationAttributeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
