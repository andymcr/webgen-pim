...
package uk.ac.man.cs.mdsd.webgen.persistence.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(PersistenceDiagramEditorPlugin.ID, IParserEditStatus.UNEDITABLE,
