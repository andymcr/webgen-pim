 ...
 * @generated
 */
public class DataTypeAttributeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DataTypeAttributeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PersistenceParserProvider.getParser(PersistenceElementTypes.DataTypeAttribute_3001,
					getParserElement(), PersistenceVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.persistence.diagram.edit.parts.DataTypeAttributeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
