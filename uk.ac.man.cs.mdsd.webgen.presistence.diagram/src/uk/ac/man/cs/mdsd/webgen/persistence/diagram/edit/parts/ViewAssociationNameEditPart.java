 ...
 * @generated
 */
public class ViewAssociationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ViewAssociationNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PersistenceParserProvider.getParser(PersistenceElementTypes.ViewAssociation_3011,
					getParserElement(), PersistenceVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.persistence.diagram.edit.parts.ViewAssociationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
