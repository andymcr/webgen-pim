 ...
 * @generated
 */
public class PersistenceModelingAssistantProvider extends ModelingAssistantProvider {
	...
	*/
	protected EObject selectElement(EObject[] elements) {
		...
		dialog.setMessage(Messages.PersistenceModelingAssistantProviderMessage);
		dialog.setTitle(Messages.PersistenceModelingAssistantProviderTitle);
