...
import uk.ac.man.cs.mdsd.webgen.persistence.diagram.edit.policies.ViewAssociationItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.persistence.diagram.part.PersistenceVisualIDRegistry;

/**
 * @generated
 */
public class ViewAssociationEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ViewAssociationNameEditPart) {
			((ViewAssociationNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAttributeNameLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PersistenceVisualIDRegistry.getType(ViewAssociationNameEditPart.VISUAL_ID));
	}
