...
import uk.ac.man.cs.mdsd.webgen.persistence.diagram.edit.policies.PersistenceTextSelectionEditPolicy;
 ...
 * @generated
 */
public class AssociationWithoutContainmentCardinalityEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				PersistenceVisualIDRegistry.getType(
						uk.ac.man.cs.mdsd.webgen.persistence.diagram.edit.parts.AssociationWithoutContainmentCardinalityEditPart.VISUAL_ID),
				new Point(0, 60));
	}
	...
	* @generated
	*/
	public AssociationWithoutContainmentCardinalityEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new PersistenceTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return PersistenceElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PersistenceParserProvider.getParser(PersistenceElementTypes.AssociationWithoutContainment_4001,
					getParserElement(), PersistenceVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.persistence.diagram.edit.parts.AssociationWithoutContainmentCardinalityEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(
					new ComboDirectEditManager(this, null, PersistenceEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
