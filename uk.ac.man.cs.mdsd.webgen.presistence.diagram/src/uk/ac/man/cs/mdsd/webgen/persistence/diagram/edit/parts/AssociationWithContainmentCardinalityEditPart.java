 ...
 * @generated
 */
public class AssociationWithContainmentCardinalityEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				PersistenceVisualIDRegistry.getType(
						uk.ac.man.cs.mdsd.webgen.persistence.diagram.edit.parts.AssociationWithContainmentCardinalityEditPart.VISUAL_ID),
				new Point(0, 60));
	}
	...
	* @generated
	*/
	public AssociationWithContainmentCardinalityEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PersistenceParserProvider.getParser(PersistenceElementTypes.AssociationWithContainment_4002,
