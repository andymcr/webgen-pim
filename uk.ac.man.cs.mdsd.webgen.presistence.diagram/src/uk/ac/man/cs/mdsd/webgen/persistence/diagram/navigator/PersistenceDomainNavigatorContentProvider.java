 ...
 * @generated
 */
public class PersistenceDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	* @generated
	*/
	public PersistenceDomainNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof PersistenceDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier
					.getChildren(((PersistenceDomainNavigatorItem) parentElement).getEObject()), parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new PersistenceDomainNavigatorItem((EObject) objects[i], parentElement,
