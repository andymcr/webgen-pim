...
import uk.ac.man.cs.mdsd.webgen.persistence.diagram.edit.policies.ModelLabel2ItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.persistence.diagram.part.PersistenceVisualIDRegistry;

/**
 * @generated
 */
public class ModelLabel2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public ModelLabel2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ModelLabel2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ModelLabelName2EditPart) {
			((ModelLabelName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureModelLabelNameLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PersistenceVisualIDRegistry.getType(ModelLabelName2EditPart.VISUAL_ID));
	}
