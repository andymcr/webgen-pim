 ...
 * @generated
 */
public class AssociationWithoutContainmentNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				PersistenceVisualIDRegistry.getType(
						uk.ac.man.cs.mdsd.webgen.persistence.diagram.edit.parts.AssociationWithoutContainmentNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public AssociationWithoutContainmentNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(
					new TextDirectEditManager(this, null, PersistenceEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
