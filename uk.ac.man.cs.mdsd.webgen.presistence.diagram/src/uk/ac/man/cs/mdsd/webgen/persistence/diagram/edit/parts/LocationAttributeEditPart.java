...
import uk.ac.man.cs.mdsd.webgen.persistence.diagram.edit.policies.LocationAttributeItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.persistence.diagram.part.PersistenceVisualIDRegistry;

/**
 * @generated
 */
public class LocationAttributeEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public LocationAttributeEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new LocationAttributeItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LocationAttributeNameEditPart) {
			((LocationAttributeNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAttributeNameLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PersistenceVisualIDRegistry.getType(LocationAttributeNameEditPart.VISUAL_ID));
	}
