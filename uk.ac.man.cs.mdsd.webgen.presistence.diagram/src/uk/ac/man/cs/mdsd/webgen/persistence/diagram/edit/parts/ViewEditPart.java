...
import uk.ac.man.cs.mdsd.webgen.persistence.diagram.edit.policies.ViewItemSemanticEditPolicy;
...
public class ViewEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ViewNameEditPart) {
			((ViewNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureEntityNameLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PersistenceVisualIDRegistry.getType(ViewNameEditPart.VISUAL_ID));
	}
	...
	*/
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == PersistenceElementTypes.EncapsulatedAttribute_3009) {
				return getChildBySemanticHint(
						PersistenceVisualIDRegistry.getType(ViewAttributeCompartmentEditPart.VISUAL_ID));
			}
			if (type == PersistenceElementTypes.EncapsulatedAssociation_3010) {
				return getChildBySemanticHint(
						PersistenceVisualIDRegistry.getType(ViewAttributeCompartmentEditPart.VISUAL_ID));
			}
			if (type == PersistenceElementTypes.ViewAssociation_3011) {
				return getChildBySemanticHint(
						PersistenceVisualIDRegistry.getType(ViewAttributeCompartmentEditPart.VISUAL_ID));
			}
		}
