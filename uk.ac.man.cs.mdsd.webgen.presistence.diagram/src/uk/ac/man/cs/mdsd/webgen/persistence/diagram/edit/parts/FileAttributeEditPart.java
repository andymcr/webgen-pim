...
import uk.ac.man.cs.mdsd.webgen.persistence.diagram.edit.policies.FileAttributeItemSemanticEditPolicy;
import uk.ac.man.cs.mdsd.webgen.persistence.diagram.part.PersistenceVisualIDRegistry;

/**
 * @generated
 */
public class FileAttributeEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public FileAttributeEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new FileAttributeItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FileAttributeNameEditPart) {
			((FileAttributeNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAttributeNameLabel());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PersistenceVisualIDRegistry.getType(FileAttributeNameEditPart.VISUAL_ID));
	}
