 ...
 * @generated
 */
public class PersistenceBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	* @generated
	*/
	protected PersistenceBaseItemSemanticEditPolicy(IElementType elementType) {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(PersistenceVisualIDRegistry.getVisualID((View) view));
	...
	*/
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = PersistenceElementTypes.getElementType(getVisualID(request));
	...
	*/
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = PersistenceDiagramEditorPlugin.getInstance().getLinkConstraints();
		if (cached == null) {
			PersistenceDiagramEditorPlugin.getInstance().setLinkConstraints(cached = new LinkConstraints());
		}
		return cached;
	}
