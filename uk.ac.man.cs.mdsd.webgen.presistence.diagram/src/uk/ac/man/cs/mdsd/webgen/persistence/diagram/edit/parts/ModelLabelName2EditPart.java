 ...
 * @generated
 */
public class ModelLabelName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ModelLabelName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PersistenceParserProvider.getParser(PersistenceElementTypes.ModelLabel_3008, getParserElement(),
					PersistenceVisualIDRegistry.getType(
							uk.ac.man.cs.mdsd.webgen.persistence.diagram.edit.parts.ModelLabelName2EditPart.VISUAL_ID));
		}
		return parser;
	}
