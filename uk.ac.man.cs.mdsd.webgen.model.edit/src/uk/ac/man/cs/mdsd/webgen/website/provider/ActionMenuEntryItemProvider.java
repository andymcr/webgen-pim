...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.webgen.website.ActionMenuEntry} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionMenuEntryItemProvider extends MenuEntryItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebsitePackage.Literals.ACTION_MENU_ENTRY__DESTINATION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebsitePackage.Literals.ACTION_MENU_ENTRY__QUERY);
		}
