...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.webgen.website.ImageManipulation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImageManipulationItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebsitePackage.Literals.IMAGE_MANIPULATION__JPEG_QUALITY,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebsitePackage.Literals.IMAGE_MANIPULATION__FILTERS);
		}
