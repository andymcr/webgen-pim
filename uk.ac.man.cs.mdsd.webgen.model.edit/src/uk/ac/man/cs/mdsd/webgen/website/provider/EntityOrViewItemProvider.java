		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EntityOrView_servedBy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EntityOrView_servedBy_feature", "_UI_EntityOrView_type"),
				 WebsitePackage.Literals.ENTITY_OR_VIEW__SERVED_BY,
				 true,
				 false,
				 true,
				 null,
