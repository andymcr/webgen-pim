...
/**
 * This is the item provider adapter for a {@link uk.ac.man.cs.mdsd.webgen.website.QueryActual} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QueryActualItemProvider 
	...
	protected void addParameterPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(new ItemPropertyDescriptor(
			...
			WebsitePackage.Literals.QUERY_ACTUAL__PARAMETER,
			true, false, true, null,
			getString("_UI_InterfacePropertyCategory"),
			null) {
				@Override
				public Collection<?> getChoiceOfValues(Object object) {
					if (object instanceof QueryActual) {
						final QueryInstance query
							= (QueryInstance) ((QueryActual) object).eContainer();
						if (query.getQuery() != null) {
							return query.getQuery().getParameters();
						}
					}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebsitePackage.Literals.QUERY_ACTUAL__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((QueryActual)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(QueryActual.class)) {
			case WebsitePackage.QUERY_ACTUAL__VALUE:
