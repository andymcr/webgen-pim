 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.api.impl.ResourceSelectionImpl#getParentResource <em>Parent Resource</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.api.impl.ResourceSelectionImpl#getName <em>Name</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.api.impl.ResourceSelectionImpl#getSelection <em>Selection</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.api.impl.ResourceSelectionImpl#getUriElement <em>Uri Element</em>}</li>
 *   <li>{@link work.andycarpenter.webgen.pims.api.impl.ResourceSelectionImpl#getDefaultSerializationGroups <em>Default Serialization Groups</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceSelectionImpl extends MinimalEObjectImpl.Container implements ResourceSelection {
	 ...
	 * @ordered
	 */
	protected EStructuralFeature.Internal.SettingDelegate NAME__ESETTING_DELEGATE = ((EStructuralFeature.Internal)ApiPackage.Literals.RESOURCE_SELECTION__NAME).getSettingDelegate();
