...
import work.andycarpenter.webgen.pims.api.ApiFactory;
...
public class ApiPackageImpl extends EPackageImpl implements ApiPackage {
	 ...
	 * @see work.andycarpenter.webgen.pims.api.ApiPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(apiEClass, work.andycarpenter.webgen.pims.api.API.class, "API", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAPI_Resources(), this.getResource(), null, "resources", null, 0, -1, work.andycarpenter.webgen.pims.api.API.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
