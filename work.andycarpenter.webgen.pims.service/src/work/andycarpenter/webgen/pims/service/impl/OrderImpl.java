 ...
 * </p>
 * <ul>
 *   <li>{@link work.andycarpenter.webgen.pims.service.impl.OrderImpl#getPath <em>Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class OrderImpl extends MinimalEObjectImpl.Container implements Order {
	...
	protected EClass eStaticClass() {
		return ServicePackage.Literals.ORDER;
	}
	...
	public void setPath(Variable newPath) {
		if (newPath != path) {
			...
			if (path != null)
				msgs = ((InternalEObject)path).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ServicePackage.ORDER__PATH, null, msgs);
			if (newPath != null)
				msgs = ((InternalEObject)newPath).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ServicePackage.ORDER__PATH, null, msgs);
			msgs = basicSetPath(newPath, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePackage.ORDER__PATH, newPath, newPath));
	}
