...
/**
 * This is the item provider adapter for a {@link security.Security} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Security_authentication_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Security_authentication_feature", "_UI_Security_type"),
				 SecurityPackage.Literals.SECURITY__AUTHENTICATION,
				 true,
				 false,
				 true,
				 null,
